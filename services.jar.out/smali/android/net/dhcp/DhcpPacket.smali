...
.field protected static final DHCP_STATIC_ROUTE:B = 0x21t
...
.method protected fillInPacket(ILjava/net/Inet4Address;Ljava/net/Inet4Address;SSLjava/nio/ByteBuffer;BZ)V
    ...
    .line 345
    .local v8, "destIpArray":[B
    invoke-virtual/range {p3 .. p3}, Ljava/net/Inet4Address;->getAddress()[B

    move-result-object v16

    .line 346
    .local v16, "srcIpArray":[B
    const/4 v13, 0x0

    .line 347
    .local v13, "ipHeaderOffset":I
    const/4 v14, 0x0

    .line 348
    .local v14, "ipLengthOffset":I
    const/4 v12, 0x0

    .line 349
    .local v12, "ipChecksumOffset":I
    const/4 v10, 0x0

    .line 350
    .local v10, "endIpHeader":I
    const/16 v18, 0x0

    .line 351
    .local v18, "udpHeaderOffset":I
    const/16 v20, 0x0

    .line 352
    .local v20, "udpLengthOffset":I
    const/16 v17, 0x0

    .line 354
    .local v17, "udpChecksumOffset":I
    ...
    .line 358
    sget-object v22, Landroid/net/dhcp/DhcpPacket;->ETHER_BROADCAST:[B
    ...
    .line 360
    sget v22, Landroid/system/OsConstants;->ETH_P_IP:I
    ...
    .line 398
    .local v6, "bootpBeginOffset":I
    const/4 v7, 0x0

    .line 399
    .local v7, "bootpEndOffset":I
    invoke-virtual/range {p6 .. p6}, Ljava/nio/ByteBuffer;->position()I
    ...
    iget-short v0, v0, Landroid/net/dhcp/DhcpPacket;->mSecs:S
    ...
    iget-object v0, v0, Landroid/net/dhcp/DhcpPacket;->mClientIp:Ljava/net/Inet4Address;

    move-object/from16 v22, v0

    invoke-virtual/range {v22 .. v22}, Ljava/net/Inet4Address;->getAddress()[B
    ...
    iget-object v0, v0, Landroid/net/dhcp/DhcpPacket;->mYourIp:Ljava/net/Inet4Address;
    ...
    iget-object v0, v0, Landroid/net/dhcp/DhcpPacket;->mNextIp:Ljava/net/Inet4Address;
    ...
    iget-object v0, v0, Landroid/net/dhcp/DhcpPacket;->mRelayIp:Ljava/net/Inet4Address;
    ...
    .line 433
    const-string v22, "DhcpPacket"

    new-instance v23, Ljava/lang/StringBuilder;

    invoke-direct/range {v23 .. v23}, Ljava/lang/StringBuilder;-><init>()V

    const-string v24, "bootpBeginOffset:"
    ...
    const-string v24, ", bootpEndOffset:"
    ...
    .line 435
    .local v9, "diffBytes":I
    const/16 v5, 0x12c

    .line 436
    .local v5, "BOOTP_MESSAGE_LENTH_MIN":I
    rsub-int v15, v9, 0x12c

    .line 437
    .local v15, "needPadNum":I
    if-lez v15, :cond_3
    ...
    .line 413
    .end local v5    # "BOOTP_MESSAGE_LENTH_MIN":I
    .end local v9    # "diffBytes":I
    .end local v11    # "i":I
    .end local v15    # "needPadNum":I
    :cond_2
    const/16 v22, 0x0
    ...
    .line 445
    .restart local v5    # "BOOTP_MESSAGE_LENTH_MIN":I
    .restart local v9    # "diffBytes":I
    .restart local v15    # "needPadNum":I
    :cond_3
    invoke-virtual/range {p6 .. p6}, Ljava/nio/ByteBuffer;->position()I
    ...
    invoke-static/range {v22 .. v22}, Landroid/net/dhcp/DhcpPacket;->intAbs(S)I
    ...
    invoke-virtual {v0, v14, v1}, Ljava/nio/ByteBuffer;->putShort(IS)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v0, v1, v2, v13, v10}, Landroid/net/dhcp/DhcpPacket;->checksum(Ljava/nio/ByteBuffer;III)I
    ...
    invoke-virtual {v0, v12, v1}, Ljava/nio/ByteBuffer;->putShort(IS)Ljava/nio/ByteBuffer;

    .line 479
    .end local v19    # "udpLen":S
    .end local v21    # "udpSeed":I
    :cond_5
    return-void
.end method
