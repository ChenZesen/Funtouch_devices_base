...
.super Lcom/android/server/AbsInputMethodManagerService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/InputMethodManagerService$SplitModeSettingsObserver;,
...
.field static final MAIN_INPUT_SHOW_VALUE:I = 0x1
...
.field static final SUB_INPUT_SHOW_VALUE:I = 0x2

.field static final TAG_STATIC:Ljava/lang/String; = "InputMethodManagerService_STATIC"

.field private static final TAG_TRY_SUPPRESSING_IME_SWITCHER:Ljava/lang/String; = "TrySuppressingImeSwitcher"

.field static final TIME_TO_RECONNECT:J = 0xbb8L

.field static mHasSubInputMethod:Z

.field static mTotalShown:I
...
.field final mSplitModeObserver:Lcom/android/server/InputMethodManagerService$SplitModeSettingsObserver;

.field private mStatusBar:Lcom/android/server/statusbar/StatusBarManagerService;

.field mSubInputMethod:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/InputMethodManagerService;->IS_ENG:Z
    ...
    sput-boolean v0, Lcom/android/server/InputMethodManagerService;->IS_LOG_CTRL_OPEN:Z

    .line 170
    sget-boolean v0, Lcom/android/server/InputMethodManagerService;->IS_LOG_CTRL_OPEN:Z

    if-nez v0, :cond_0

    sget-boolean v0, Lcom/android/server/InputMethodManagerService;->IS_ENG:Z
    ...
    :cond_1
    sput-boolean v2, Lcom/android/server/InputMethodManagerService;->DEBUG_RESTORE:Z

    .line 557
    const-string v0, "com.baidu.input_bbk.service/.PinyinIME"

    sput-object v0, Lcom/android/server/InputMethodManagerService;->ACTIVITY_SPLITMODE_DEFAULT_INPUTMETHOD:Ljava/lang/String;

    .line 558
    const-string v0, "com.baidu.input_bbk.service"

    sput-object v0, Lcom/android/server/InputMethodManagerService;->ACTIVITY_INPUTMETHOD_DEFAULT_PKGNAME:Ljava/lang/String;

    .line 562
    sput v1, Lcom/android/server/InputMethodManagerService;->mTotalShown:I

    .line 565
    sput-boolean v1, Lcom/android/server/InputMethodManagerService;->mHasSubInputMethod:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .prologue
    .line 979
    invoke-direct {p0}, Lcom/android/server/AbsInputMethodManagerService;-><init>()V

    .line 176
    const-string v0, "InputMethodManagerService"

    iput-object v0, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
    ...
    iput-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mSplitMode:Z

    .line 556
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mHasVivoInputMethod:Z

    .line 566
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mSubInputMethod:Z

    .line 981
    instance-of v0, p0, Lcom/android/server/VivoSecureInputMethodManagerService;

    if-eqz v0, :cond_3

    .line 982
    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;

    const-string v1, "set TAG to VivoSecureInputMethodManagerService"
    ...
    invoke-direct {p0, v0}, Lcom/android/server/InputMethodManagerService;->decideInputStateInSplitMode(Landroid/content/Context;)V

    .line 1152
    new-instance v0, Lcom/android/server/InputMethodManagerService$SplitModeSettingsObserver;

    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v1}, Lcom/android/server/InputMethodManagerService$SplitModeSettingsObserver;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/InputMethodManagerService;->mSplitModeObserver:Lcom/android/server/InputMethodManagerService$SplitModeSettingsObserver;

    .line 1160
    :goto_4
    invoke-virtual {p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsIsSecureIMMS()Z
    ...
    .end local v6    # "broadcastFilter":Landroid/content/IntentFilter;
    ...
    const-string v1, "set TAG to InputMethodManagerService"
    ...
    .restart local v6    # "broadcastFilter":Landroid/content/IntentFilter;
...
.method static synthetic access$000(Lcom/android/server/InputMethodManagerService;Landroid/content/Context;)V
    .locals 0
    ...
    .prologue
    .line 160
    invoke-direct {p0, p1}, Lcom/android/server/InputMethodManagerService;->decideInputStateInSplitMode(Landroid/content/Context;)V
...
.method static synthetic access$600(Lcom/android/server/InputMethodManagerService;Landroid/os/IBinder;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method private chooseNewDefaultIMELocked()Z
    ...
    .line 3349
    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method private decideInputStateInSplitMode(Landroid/content/Context;)V
    .locals 9
    .param p1, "context"    # Landroid/content/Context;
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mSplitMode:Z
    ...
    sget-object v6, Lcom/android/server/InputMethodManagerService;->ACTIVITY_INPUTMETHOD_DEFAULT_PKGNAME:Ljava/lang/String;
    ...
    :goto_3
    iput-boolean v5, p0, Lcom/android/server/InputMethodManagerService;->mHasVivoInputMethod:Z
    ...
    .line 606
    iput-boolean v4, p0, Lcom/android/server/InputMethodManagerService;->mHasVivoInputMethod:Z
    ...
    .line 610
    iget-object v3, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "decideInputStateInSplitMode mHasVivoInputMethod = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/server/InputMethodManagerService;->mHasVivoInputMethod:Z

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, ", mSplitMode = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/server/InputMethodManagerService;->mSplitMode:Z
...
.method private findLastResortApplicableShortcutInputMethodAndSubtypeLocked(Ljava/lang/String;)Landroid/util/Pair;
    ...
    .line 3943
    iget-object v11, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method private handleSetInteractive(Z)V
    ...
    .line 3333
    invoke-virtual {p0, p1}, Lcom/android/server/InputMethodManagerService;->vivoAbsSetInteractive(Z)V
...
.method private resetSelectedInputMethodAndSubtypeLocked(Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method static restoreEnabledInputMethods(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 737
    const-string v7, "InputMethodManagerService_STATIC"

    const-string v8, "[TAG_STATIC]Restoring enabled input methods:"
    ...
    const-string v9, "[TAG_STATIC]prev="
    ...
    const-string v9, "[TAG_STATIC] new="
    ...
    const-string v8, "[TAG_STATIC]Merged IME string:"
...
.method private runDebug(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Z)V
    ...
    .line 4473
    const-string v2, "InputMethodManagerService DEBUG is turn on!"
    ...
    .line 4475
    :cond_0
    const-string v2, "InputMethodManagerService DEBUG is turn off!"
...
.method private setInputMethodWithSubtypeIdLocked(Landroid/os/IBinder;Ljava/lang/String;I)V
    ...
    .line 3046
    iget-object v2, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method private showInputMethodMenu(Z)V
    ...
    const-string v28, "Show switching menu. showAuxSubtypes="
    ...
    sget-object v26, Lvivo/util/VivoThemeUtil$ThemeType;->DIALOG_ALERT:Lvivo/util/VivoThemeUtil$ThemeType;

    invoke-static/range {v26 .. v26}, Lvivo/util/VivoThemeUtil;->getSystemThemeStyle(Lvivo/util/VivoThemeUtil$ThemeType;)I
    ...
    invoke-direct {v6, v0, v1, v2, v7}, Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;-><init>(Landroid/content/Context;ILjava/util/List;I)V
    ...
    .restart local v23    # "settingsContext":Landroid/content/Context;
...
.method private switchUserLocked(I)V
    ...
    const-string v4, "Switching user stage 1/3. newUserId="
    ...
    const-string v4, "Switching user stage 2/3. newUserId="
    ...
    const-string v4, "Switching user stage 3/3. newUserId="
...
.method private updateSystemUiLocked(Landroid/os/IBinder;II)V
    ...
    .prologue
    .line 2068
    invoke-virtual {p0, p1}, Lcom/android/server/InputMethodManagerService;->calledWithValidToken(Landroid/os/IBinder;)Z
    ...
    .line 2070
    .local v6, "uid":I
    iget-object v7, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
    ...
    .line 2076
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsShouldUpdateSystemUi()Z
    ...
    const-string v8, "VivoSecureInputMethodManagerService not updateSystemUiLocked"
    ...
    const-string v9, "--- show notification: label =  "
    ...
    sget-boolean v7, Landroid/util/VivoSmartMultiWindowConfig;->IS_EXPORT:Z
    ...
    iget v8, p0, Lcom/android/server/InputMethodManagerService;->mImeWindowVis:I

    invoke-virtual {v7, v8}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method attachNewInputLocked(Z)Lcom/android/internal/view/InputBindResult;
    ...
    const-string v3, "attachNewInputLocked mBoundToMethod="

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mBoundToMethod:Z
    ...
    const-string v3, " ,mShowRequested="

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mShowRequested:Z
    ...
    .line 1545
    :cond_1
    invoke-virtual {p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsbindInput()V
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/InputMethodManagerService;->shouldBuildInputMethodList(Ljava/lang/String;)Z
    ...
    const-string v17, "ro.vivo.op.entry"
    ...
    const-string v17, "ro.product.customize.bbk"
    ...
    .line 3442
    const-string v17, "com.iflytek.inputmethod.oem/com.iflytek.inputmethod.FlyIME"
    ...
    .line 3443
    const-string v6, "com.iflytek.inputmethod.oem/.FlyIME"
    ...
    invoke-virtual {v0, v6}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->putSelectedInputMethod(Ljava/lang/String;)V
    ...
    const-string v17, "com.baidu.input_bbk.service"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 4368
    iget-object v11, v2, Lcom/android/server/InputMethodManagerService$ClientState;->client:Lcom/android/internal/view/IInputMethodClient;
    ...
    const-string v13, "    client.asBinder()="
    ...
    invoke-interface {v13}, Lcom/android/internal/view/IInputMethodClient;->asBinder()Landroid/os/IBinder;
    ...
    const-string v13, "  mCurInputContext="

    invoke-virtual {v11, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v13, p0, Lcom/android/server/InputMethodManagerService;->mCurInputContext:Lcom/android/internal/view/IInputContext;
    ...
    .line 4375
    iget-object v11, p0, Lcom/android/server/InputMethodManagerService;->mCurInputContext:Lcom/android/internal/view/IInputContext;
    ...
    const-string v13, "  mCurInputContext.asBinder()="
    ...
    invoke-interface {v13}, Lcom/android/internal/view/IInputContext;->asBinder()Landroid/os/IBinder;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    .line 3143
    iget-object v10, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Unknown subtype picker mode = "
    ...
    const-string v12, ".createSession("
    ...
    const-string v12, ".onUnbindMethod("
    ...
    const-string v12, ".setUserActionNotificationSequenceNumber("
    ...
    const-string v12, ".handleHardKeyboardStatusChange("
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    const-string v6, "hideCurrentInputLocked shouldHideSoftInput="
    ...
    const-string v5, "Keyboard hidden by explicitly"
    ...
    :goto_4
    invoke-virtual {v2, v3}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    ...
    const-string v5, "Keyboard hidden by implicitly"
    ...
    .line 2564
    :cond_d
    sget-boolean v4, Lcom/android/server/InputMethodManagerService;->mHasSubInputMethod:Z

    if-eqz v4, :cond_11

    .line 2565
    iget-boolean v4, p0, Lcom/android/server/InputMethodManagerService;->mSubInputMethod:Z

    if-eqz v4, :cond_f

    .line 2566
    sget v4, Lcom/android/server/InputMethodManagerService;->mTotalShown:I
    ...
    sput v4, Lcom/android/server/InputMethodManagerService;->mTotalShown:I
    ...
    sget v5, Lcom/android/server/InputMethodManagerService;->mTotalShown:I

    if-lez v5, :cond_10

    :goto_7
    invoke-virtual {v4, v2}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
...
.method public hideInputMethodMenuFromWindowManager()V
    .locals 2
    ...
    const-string v1, "hideInputMethodMenuFromWindowManager"
...
.method public hideSoftInput(Lcom/android/internal/view/IInputMethodClient;ILandroid/os/ResultReceiver;)Z
    ...
    iget-object v6, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-wide v4, p0, Lcom/android/server/InputMethodManagerService;->mLastBindTime:J
    ...
    .line 1906
    sget-boolean v3, Lcom/android/server/InputMethodManagerService;->mHasSubInputMethod:Z

    if-eqz v3, :cond_6

    .line 1907
    iget-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mSubInputMethod:Z

    if-eqz v3, :cond_4

    .line 1908
    sget v3, Lcom/android/server/InputMethodManagerService;->mTotalShown:I
    ...
    sput v3, Lcom/android/server/InputMethodManagerService;->mTotalShown:I
    ...
    :goto_1
    invoke-virtual {v3, v0}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    ...
    invoke-virtual {v1, v3, v4, v5}, Lcom/android/internal/os/HandlerCaller;->obtainMessageIO(IILjava/lang/Object;)Landroid/os/Message;
...
.method onSessionCreated(Lcom/android/internal/view/IInputMethod;Lcom/android/internal/view/IInputMethodSession;Landroid/view/InputChannel;)V
    ...
    const-string v3, "onSessionCreated mCurClient="
    ...
    const-string v3, " ,mCurClient.curSession="
    ...
    const-string v4, "onSessionCreated InputBindResult res:"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 1291
    :try_start_0
    invoke-super {p0, p1, p2, p3, p4}, Lcom/android/server/AbsInputMethodManagerService;->onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    .prologue
    .line 2037
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/server/InputMethodManagerService;->vivoAbsIsFromSecureInputMethod(Landroid/os/IBinder;II)Z
    ...
    invoke-virtual {v1, v3}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    .line 2299
    :cond_3
    iget-object v8, p0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;
...
.method public setSubInputMethod()V
    .locals 1
    ...
    .line 617
    sput-boolean v0, Lcom/android/server/InputMethodManagerService;->mHasSubInputMethod:Z
...
.method showCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    const-string v6, "showCurrentInputLocked: mCurToken="
    ...
    invoke-direct {p0, v4, v5, v6}, Lcom/android/server/InputMethodManagerService;->bindCurrentInputMethodService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v4, v2}, Lcom/android/server/InputMethodManagerService$KeyboardDetect;->setKeyboardState(I)V
    ...
    const-string v5, "Keyboard in foreground"
    ...
    :goto_1
    invoke-virtual {v2, v1}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    ...
    .line 2418
    :cond_8
    sget-boolean v1, Lcom/android/server/InputMethodManagerService;->mHasSubInputMethod:Z

    if-eqz v1, :cond_d

    .line 2419
    iget-boolean v1, p0, Lcom/android/server/InputMethodManagerService;->mSubInputMethod:Z

    if-eqz v1, :cond_a

    .line 2420
    sget v1, Lcom/android/server/InputMethodManagerService;->mTotalShown:I
    ...
    :goto_4
    invoke-virtual {v4, v1}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    ...
    :goto_5
    invoke-virtual {v1, v2}, Lcom/android/server/wm/WindowManagerService;->updateImeWindowVisible(I)V
    ...
    .line 2447
    iput-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mBoundToMethod:Z
...
.method startInputUncheckedLocked(Lcom/android/server/InputMethodManagerService$ClientState;Lcom/android/internal/view/IInputContext;Landroid/view/inputmethod/EditorInfo;I)Lcom/android/internal/view/InputBindResult;
    ...
    const-string v5, "startInputUncheckedLocked  mCurSeq="
    ...
    const-string v5, " ,mIsInteractive="
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/InputMethodManagerService;->vivoAbsSetCurClient(Landroid/os/IBinder;)V
    ...
    const-string v4, "attachNewInputLocked("
    ...
    const-string v2, "requestClientSessionLocked()"
    ...
    const-string v1, "startInputInnerLocked()"
...
.method unbindCurrentClientLocked()V
    ...
    .line 1501
    :cond_1
    invoke-virtual {p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsUnbindInput()V
    ...
    .line 1510
    invoke-virtual {p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsChangeClient()V
...
.method updateInputMethodsFromSettingsLocked(Z)V
    ...
    .line 2229
    const-string v0, "com.iflytek.inputmethod.oem/com.iflytek.inputmethod.FlyIME"
    ...
    .line 2231
    const-string v10, "com.iflytek.inputmethod.oem/.FlyIME"

    .line 2232
    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->mSettings:Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;

    invoke-virtual {v0, v10}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->putSelectedInputMethod(Ljava/lang/String;)V
...
.method public windowGainedFocus(Lcom/android/internal/view/IInputMethodClient;Landroid/os/IBinder;IIILandroid/view/inputmethod/EditorInfo;Lcom/android/internal/view/IInputContext;)Lcom/android/internal/view/InputBindResult;
    ...
    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->TAG:Ljava/lang/String;

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "windowGainedFocus: calling pid: "
    ...
    .line 2654
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/InputMethodManagerService;->vivoAbsSetCurFocusedWindow()V
    ...
    iget-boolean v12, v0, Lcom/android/server/InputMethodManagerService;->mInputShown:Z
    ...
    const-string v14, "Currnt client changed, hide current input."
