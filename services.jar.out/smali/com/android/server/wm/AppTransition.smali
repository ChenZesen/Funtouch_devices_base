...
# static fields
.field public static final ACTIVITY_PAUSED:I = 0x0

.field public static final ACTIVITY_RESUMED:I = 0x2

.field public static final ACTIVITY_RESUMING:I = 0x1
...
.field private static final NEXT_TRANSIT_TYPE_THUMBNAIL_SCALE_DOWN_VIVO:I = 0xa

.field private static final NEXT_TRANSIT_TYPE_THUMBNAIL_SCALE_UP:I = 0x3

.field private static final NEXT_TRANSIT_TYPE_THUMBNAIL_SCALE_UP_VIVO:I = 0x9
...
.field private static final TRANSITION_DURATION_TOTAL:I = 0x15e

.field private static final TRANSITION_ENTER_APP_ALPHA_DURATION:I = 0x1c

.field private static final TRANSITION_ENTER_APP_ALPHA_OFFSET:I = 0x0

.field private static final TRANSITION_ENTER_ICON_ALPHA_DURATION:I = 0x32

.field private static final TRANSITION_ENTER_ICON_ALPHA_OFFSET:I = 0x1d

.field private static final TRANSITION_EXIT_APP_ALPHA_DURATION:I = 0x74

.field private static final TRANSITION_EXIT_APP_ALPHA_OFFSET:I = 0x2e

.field private static final TRANSITION_EXIT_APP_CENTER_ALPHA_DURATION:I = 0xe6

.field private static final TRANSITION_EXIT_APP_CENTER_ALPHA_OFFSET:I = 0x78

.field private static final TRANSITION_EXIT_ICON_ALPHA_DURATION:I = 0x2d

.field private static final TRANSITION_LAUNCHER_SCALE:F = 0.8f
...
.field private final mThumbnailBezierVivoInterpolator:Landroid/view/animation/Interpolator;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/AppTransition;->mBezierPath:Landroid/graphics/Path;

    .line 1387
    new-instance v0, Landroid/view/animation/PathInterpolator;

    iget-object v1, p0, Lcom/android/server/wm/AppTransition;->mBezierPath:Landroid/graphics/Path;

    invoke-direct {v0, v1}, Landroid/view/animation/PathInterpolator;-><init>(Landroid/graphics/Path;)V

    iput-object v0, p0, Lcom/android/server/wm/AppTransition;->mThumbnailBezierVivoInterpolator:Landroid/view/animation/Interpolator;
...
.method createThumbnailEnterExitAnimationVivoLocked(IIII)Landroid/view/animation/Animation;
    .locals 22
    .param p1, "thumbTransitState"    # I
    .param p2, "appWidth"    # I
    .param p3, "appHeight"    # I
    ...
    .line 1486
    .end local v18    # "thumbHeight":F
    .end local v19    # "thumbHeightI":I
    .end local v20    # "thumbWidth":F
    .end local v21    # "thumbWidthI":I
    :cond_0
    const/16 v21, 0x0
    ...
    .line 1487
    .restart local v21    # "thumbWidthI":I
    :cond_1
    ...
    .line 1489
    .restart local v20    # "thumbWidth":F
    :cond_2
    const/16 v19, 0x0
    ...
    .line 1490
    .restart local v19    # "thumbHeightI":I
    :cond_3
    ...
    .line 1495
    .restart local v18    # "thumbHeight":F
    :pswitch_0
    move/from16 v0, p2
    ...
    iget-object v6, v0, Lcom/android/server/wm/AppTransition;->mThumbnailBezierVivoInterpolator:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/view/animation/Animation;->initialize(IIII)V
    ...
    iget-boolean v6, v0, Lcom/android/server/wm/AppTransition;->mAnimateExit:Z
    ...
    invoke-direct {v8, v6, v9}, Landroid/view/animation/AlphaAnimation;-><init>(FF)V
...
.method createThumbnailScaleAnimationVivoLocked(III)Landroid/view/animation/Animation;
    .locals 19
    .param p1, "appWidth"    # I
    .param p2, "appHeight"    # I
    .param p3, "transit"    # I
    ...
    iget-object v5, v0, Lcom/android/server/wm/AppTransition;->mNextAppTransitionThumbnail:Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lcom/android/server/wm/AppTransition;->mThumbnailBezierVivoInterpolator:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v13, v5, v7}, Landroid/view/animation/AlphaAnimation;-><init>(FF)V
    ...
    invoke-virtual {v13, v10, v11}, Landroid/view/animation/Animation;->setStartOffset(J)V
    ...
    invoke-virtual {v12, v0, v1, v2, v3}, Landroid/view/animation/Animation;->initialize(IIII)V
    ...
    .line 1432
    .restart local v18    # "thumbWidthI":I
    :cond_1
    const/high16 v17, 0x3f800000    # 1.0f
    ...
    invoke-static {v5, v11}, Lcom/android/server/wm/AppTransition;->computePivot(IF)F
...
.method createThumbnailScrimScaleAnimationVivoLocked(III)Landroid/view/animation/Animation;
    .locals 19
    .param p1, "appWidth"    # I
    .param p2, "appHeight"    # I
    .param p3, "transit"    # I
...
.method isNextThumbnailTransitionScaleUpVivo()Z
    .locals 2
...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, v4, v0, v1, v2}, Lcom/android/server/wm/AppTransition;->createThumbnailEnterExitAnimationVivoLocked(IIII)Landroid/view/animation/Animation;
    ...
    const-string v14, "ANIM_THUMBNAIL_SCALE_UP_VIVO"
    ...
    .restart local v12    # "a":Landroid/view/animation/Animation;
    :cond_1f
    const-string v14, "ANIM_THUMBNAIL_SCALE_DOWN_VIVO"
...
.method overridePendingAppTransitionThumbFromLauncher(Landroid/graphics/Bitmap;IILandroid/os/IRemoteCallback;ZZ)V
    .locals 4
    .param p1, "srcThumb"    # Landroid/graphics/Bitmap;
    .param p2, "startX"    # I
    .param p3, "startY"    # I
    .param p4, "startedCallback"    # Landroid/os/IRemoteCallback;
    .param p5, "scaleUp"    # Z
    .param p6, "animateExit"    # Z

    .prologue
    const/4 v3, 0x0

    .line 1403
    const-string v1, "AppTransition"

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "overridePendingAppTransitionThumbFromLauncher, bmpWidth = "
    ...
    const-string v1, "after overridePendingAppTransitionThumbFromLauncher"
    ...
    .line 1415
    const-string v0, "persist.debug.offsetX"
    ...
    .line 1416
    const-string v0, "persist.debug.offsetY"
    ...
    .line 1419
    iput-boolean p6, p0, Lcom/android/server/wm/AppTransition;->mAnimateExit:Z
