...
.field mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
...
.field mSmartShowData:Lcom/android/server/wm/WindowSmartMultiWindowData;
    .annotation runtime Landroid/annotation/VivoHook;
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput-object v12, p0, Lcom/android/server/wm/WindowState;->mSmartShowData:Lcom/android/server/wm/WindowSmartMultiWindowData;

    .line 380
    const/4 v12, 0x0

    iput-object v12, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;

    .line 1407
    const/4 v12, 0x0

    iput-boolean v12, p0, Lcom/android/server/wm/WindowState;->mHideByFingerPrint:Z
    ...
    invoke-direct {v13, p0}, Lcom/android/server/wm/WindowState$2;-><init>(Lcom/android/server/wm/WindowState;)V

    invoke-virtual {v12, v13}, Lcom/android/server/wm/WindowManagerService$H;->post(Ljava/lang/Runnable;)Z
    ...
    iget-object v12, v0, Lcom/android/server/wm/WindowManagerService;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;

    iput-object v12, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;

    .line 547
    iget-object v12, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual {v12, v0, p0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->createWindowSmartMultiWindowData(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/WindowState;)Lcom/android/server/wm/WindowSmartMultiWindowData;
...
# virtual methods
.method public adjustInputWindowLw()V
    .locals 1
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .prologue
    .line 1899
    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->adjustInputWindowLw(Lcom/android/server/wm/WindowState;)V
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object v1, v0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual/range {v1 .. v10}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->beginComputeFrameLw(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->getDisplayMode(Lcom/android/server/wm/TaskStack;)I
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->finishApplyGravity(Lcom/android/server/wm/WindowState;II)V
...
.method hasMoved()Z
    ...
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;

    invoke-virtual {v1, p0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->shouldIgnoreAnimateMove(Lcom/android/server/wm/WindowState;)Z
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/WindowState;->mContentChanged:Z
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/WindowState;->hasMoved()Z
...
.method hideByFingerPrint(Z)V
    ...
    const-string v2, "hide by finger print, hide = "
    ...
    .line 1410
    iget-boolean v0, p0, Lcom/android/server/wm/WindowState;->mHideByFingerPrint:Z

    if-eq v0, p1, :cond_0

    .line 1411
    iput-boolean p1, p0, Lcom/android/server/wm/WindowState;->mHideByFingerPrint:Z
...
.method isConfigChanged()Z
    ...
    iget-object v2, v4, Lcom/android/server/wm/TaskStack;->mOverrideConfig:Landroid/content/res/Configuration;
    ...
    iget-object v3, v7, Lcom/android/server/wm/WindowManagerService;->mCurConfiguration:Landroid/content/res/Configuration;

    .line 1217
    .local v3, "serviceConfig":Landroid/content/res/Configuration;
    const/4 v0, 0x0
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/TaskStack;->isSplitNormalMode()Z
    ...
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    iget-object v8, v8, Lcom/android/server/wm/WindowManagerService;->mCurConfiguration:Landroid/content/res/Configuration;

    invoke-virtual {v7, p0, v8}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->getConfigurationLocked(Lcom/android/server/wm/WindowState;Landroid/content/res/Configuration;)Landroid/content/res/Configuration;

    move-result-object v1

    .line 1222
    :goto_1
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mConfiguration:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v7, v1}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I

    move-result v7

    if-nez v7, :cond_0

    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mOverrideConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v7, v2}, Landroid/content/res/Configuration;->equals(Landroid/content/res/Configuration;)Z
    ...
    .line 1230
    .end local v1    # "curConfiguration":Landroid/content/res/Configuration;
    :goto_2
    ...
    .line 1232
    iget-boolean v5, p0, Lcom/android/server/wm/WindowState;->mConfigHasChanged:Z

    or-int/2addr v5, v0

    iput-boolean v5, p0, Lcom/android/server/wm/WindowState;->mConfigHasChanged:Z
    ...
    .end local v3    # "serviceConfig":Landroid/content/res/Configuration;
    :cond_2
    ...
    .restart local v1    # "curConfiguration":Landroid/content/res/Configuration;
    .restart local v2    # "overrideConfig":Landroid/content/res/Configuration;
    .restart local v3    # "serviceConfig":Landroid/content/res/Configuration;
    :cond_3
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v1, v7, Lcom/android/server/wm/WindowManagerService;->mCurConfiguration:Landroid/content/res/Configuration;
...
.method public isDialogWindow()Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->isDialogWindow(Lcom/android/server/wm/WindowState;)Z
...
.method public isGoneForLayoutLw()Z
    ...
    iget-boolean v1, v1, Lcom/android/server/wm/WindowManagerService;->mCheckingKeyguardReady:Z
...
.method public isSplitTaskWindow()Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->isSplitTaskWindow(Lcom/android/server/wm/WindowState;)Z
...
.method public isVisibleOrBehindKeyguardLw()Z
    ...
    iget-boolean v4, v4, Lcom/android/server/wm/WindowManagerService;->mCheckingKeyguardReady:Z
...
.method reportResized()V
    ...
    const-string v17, "Reporting new frame to "
    ...
    const-string v17, "Sending new config to window "
    ...
    const-string v17, " overrideConfig="
    ...
    iget-object v2, v0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual {v2, v0, v3}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->getConfigurationLocked(Lcom/android/server/wm/WindowState;Landroid/content/res/Configuration;)Landroid/content/res/Configuration;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/wm/TaskStack;->isSplitNormalMode()Z
    ...
    const-string v17, " WITH DRAW PENDING"
    ...
    invoke-direct/range {v2 .. v11}, Lcom/android/server/wm/WindowState$3;-><init>(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/content/res/Configuration;)V
    ...
    invoke-direct {v0, v2, v15}, Lcom/android/server/wm/WindowState;->setConfiguration(Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setAppOpVisibilityLw(Z)Z
    ...
    .line 1429
    invoke-virtual {p0, v4, v4}, Lcom/android/server/wm/WindowState;->showLw(ZZ)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowState;->setAppOpVisibilityLw(Z)Z
    ...
    .end local v1    # "i":I
    :cond_1
    invoke-virtual {p0, v4, v4}, Lcom/android/server/wm/WindowState;->hideLw(ZZ)Z
...
.method public vivoChangeStackModeByActivity(IZ)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->vivoChangeStackModeByActivity(Lcom/android/server/wm/WindowState;IZ)V
