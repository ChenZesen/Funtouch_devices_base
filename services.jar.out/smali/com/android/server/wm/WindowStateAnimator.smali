...
.method applyAnimationLocked(IZ)Z
    ...
    iget-object v6, v6, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual {v6, v7, p1, p2, v0}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->vivoApplyAnimationLocked(Lcom/android/server/wm/AppWindowToken;IZLandroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->isSplitMode()Z
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->getDragToFullWindow()I
...
.method computeShownFrameLocked()V
    ...
    .line 1041
    .local v16, "selfTransformation":Z
    move-object/from16 v0, p0
    ...
    iget-object v10, v0, Lcom/android/server/wm/WindowManagerService;->mGlobalTransition:Lcom/android/server/wm/VivoGlobalTransition;

    .line 1080
    .local v10, "globalTransition":Lcom/android/server/wm/VivoGlobalTransition;
    if-eqz v10, :cond_19
    ...
    .line 1085
    .local v12, "hasGlobalTransition":Z
    :goto_4
    sget-boolean v26, Landroid/util/VivoSmartMultiWindowConfig;->ENABLE_SPLIT:Z
    ...
    iget-object v0, v0, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual/range {v26 .. v27}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->needAdjustShownFrameLw(Lcom/android/server/wm/WindowState;)Z

    move-result v13

    .line 1090
    .local v13, "needAdjust":Z
    :goto_5
    if-nez v16, :cond_2
    ...
    invoke-virtual {v15}, Lcom/android/server/wm/ScreenRotationAnimation;->isRotating()Z
    ...
    .line 1130
    invoke-virtual {v15}, Lcom/android/server/wm/ScreenRotationAnimation;->getEnterTransformation()Landroid/view/animation/Transformation;
    ...
    .line 1135
    iget-object v0, v10, Lcom/android/server/wm/VivoGlobalTransition;->mTransformation:Landroid/view/animation/Transformation;
    ...
    const-string v28, "global transformation = "
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->adjustShownFrameLw(Lcom/android/server/wm/WindowState;Landroid/graphics/Matrix;)V
    ...
    .end local v10    # "globalTransition":Lcom/android/server/wm/VivoGlobalTransition;
    .end local v12    # "hasGlobalTransition":Z
    .end local v13    # "needAdjust":Z
    .end local v14    # "screenAnimation":Z
    ...
    .line 1080
    .restart local v10    # "globalTransition":Lcom/android/server/wm/VivoGlobalTransition;
    .restart local v14    # "screenAnimation":Z
    :cond_19
    const/4 v12, 0x0
    ...
    .line 1085
    .restart local v12    # "hasGlobalTransition":Z
    :cond_1a
    const/4 v13, 0x0
    ...
    .local v11, "h":F
    .restart local v13    # "needAdjust":Z
...
.method performShowLocked()Z
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/WindowState;->mFreezeDrawing:Z
...
.method public prepareSurfaceLocked(Z)V
    ...
    const-string v5, "Hiding pendingDestroy surface in "
    ...
    const-string v5, "Exception hiding pendingDestroy surface in "
    ...
    iget-boolean v3, v2, Lcom/android/server/wm/WindowState;->mHideByFingerPrint:Z
...
.method setSurfaceBoundariesLocked(Z)V
    ...
    sget-boolean v17, Landroid/util/VivoSmartMultiWindowConfig;->IS_EXPORT:Z

    if-eqz v17, :cond_2

    iget-object v0, v15, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/wm/WindowManagerService;->isSplitMode()Z
    ...
    const-string v17, "com.mxtech.videoplayer.ad"
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/wm/WindowManagerService;->getDefaultDisplayInfoLocked()Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/wm/WindowManagerService;->getDefaultDisplayInfoLocked()Landroid/view/DisplayInfo;
    ...
    .line 1470
    iget-object v0, v15, Lcom/android/server/wm/WindowState;->mSmartShowData:Lcom/android/server/wm/WindowSmartMultiWindowData;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/wm/WindowSmartMultiWindowData;->getTransformParam()Lcom/android/server/wm/TransformParam;

    move-result-object v10

    .line 1472
    .local v10, "spec":Lcom/android/server/wm/TransformParam;
    if-eqz v10, :cond_2

    .line 1473
    iget v9, v10, Lcom/android/server/wm/TransformParam;->scale:F

    .line 1479
    .end local v10    # "spec":Lcom/android/server/wm/TransformParam;
    :cond_2
    move-object/from16 v0, p0
    ...
    .line 1554
    :cond_a
    sget-boolean v17, Landroid/util/VivoSmartMultiWindowConfig;->DEBUG_LAYOUT:Z

    if-eqz v17, :cond_b

    .line 1555
    sget-object v17, Landroid/util/VivoSmartMultiWindowConfig;->TAG_LAYOUT:Ljava/lang/String;

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string v19, "setSurfaceBoundariesLocked mSurfaceControl.setPosition mSurfaceX = "
...
.method updateSurfaceWindowCrop(Z)V
    ...
    .line 1352
    iget-object v0, v12, Lcom/android/server/wm/WindowState;->mSystemDecorRect:Landroid/graphics/Rect;

    const/4 v1, 0x0

    const/4 v3, 0x0

    iget v4, v12, Lcom/android/server/wm/WindowState;->mRequestedWidth:I

    iget v5, v12, Lcom/android/server/wm/WindowState;->mRequestedHeight:I
    ...
    iget v1, v9, Landroid/view/DisplayInfo;->appHeight:I

    invoke-virtual {v12, v0, v1}, Lcom/android/server/wm/WindowState;->isFullscreen(II)Z

    move-result v11

    .line 1378
    .local v11, "fullscreen":Z
    iget-object v2, p0, Lcom/android/server/wm/WindowStateAnimator;->mTmpClipRect:Landroid/graphics/Rect;
    ...
    .line 1384
    iget-object v7, v12, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    .line 1385
    .local v7, "attrs":Landroid/view/WindowManager$LayoutParams;
    iget v0, v2, Landroid/graphics/Rect;->left:I

    iget-object v1, v7, Landroid/view/WindowManager$LayoutParams;->surfaceInsets:Landroid/graphics/Rect;
    ...
    iget-object v0, v12, Lcom/android/server/wm/WindowState;->mMultiWindowWmsInstance:Lcom/android/server/wm/VivoSmartMultiWindowWms;
    ...
    iget v5, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceW:F

    iget v6, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceH:F

    invoke-virtual/range {v0 .. v6}, Lcom/android/server/wm/VivoSmartMultiWindowWms;->updateSurfaceWindowCrop(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;FFFF)V
    ...
    invoke-static {v12, v0, v1}, Lcom/android/server/wm/WindowManagerService;->logSurface(Lcom/android/server/wm/WindowState;Ljava/lang/String;Ljava/lang/RuntimeException;)V

    .line 1420
    :cond_5
    iget-object v0, p0, Lcom/android/server/wm/WindowStateAnimator;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-virtual {v0, v2}, Landroid/view/SurfaceControl;->setWindowCrop(Landroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, p0, v1, v3}, Lcom/android/server/wm/WindowManagerService;->reclaimSomeSurfaceMemoryLocked(Lcom/android/server/wm/WindowStateAnimator;Ljava/lang/String;Z)Z
    ...
    :cond_6
    invoke-virtual {v12}, Lcom/android/server/wm/WindowState;->isDefaultDisplay()Z
    ...
    iget-object v4, v12, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->width()I

    move-result v4

    iget-object v5, v12, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;
    ...
    iget-object v1, v12, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    neg-int v1, v1

    iget-object v3, v12, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;
    ...
    iget-object v6, v12, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;

    iget v6, v6, Landroid/graphics/Rect;->top:I

    sub-int/2addr v5, v6

    invoke-virtual {v0, v1, v3, v4, v5}, Landroid/graphics/Rect;->intersect(IIII)Z
    ...
    iget v1, v1, Lcom/android/server/wm/WindowManagerService;->mSystemDecorLayer:I
    ...
    .line 1363
    :cond_8
    iget-object v0, v12, Lcom/android/server/wm/WindowState;->mDecorFrame:Landroid/graphics/Rect;
    ...
    .line 1369
    iget-object v0, p0, Lcom/android/server/wm/WindowStateAnimator;->mTmpClipRect:Landroid/graphics/Rect;

    iget-object v1, v12, Lcom/android/server/wm/WindowState;->mSystemDecorRect:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/WindowStateAnimator;->applyDecorRect(Landroid/graphics/Rect;)V
