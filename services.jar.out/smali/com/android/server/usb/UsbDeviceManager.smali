...
.field private static final ISDEVICERW:Z
...
.field private static final IS_FAST_CHARGE_PROJECT:Z

.field public static IS_LOG_CTRL_OPEN:Z = false
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field public static final IS_NET_ENTRY:Z
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field public static final IS_NO_UMS:Z
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field private static final MSG_KEYGUARDBROADCAST:I = 0x6f

.field private static final MSG_LANGUAGE_CHANGE_NOTIFICATION_RELOAD:I = 0x6e

.field private static final MSG_NOTIFICATION_MODE_SWITCH:I = 0x67

.field private static final MSG_PLAY_USB_NOTI_SOUND:I = 0x64

.field private static final MSG_SEND_USB_HELP_BROADCAST:I = 0x65

.field private static final MSG_SET_CURRENT_FUNCTIONS:I = 0x2

.field private static final MSG_SET_USB_DATA_UNLOCKED:I = 0x6

.field private static final MSG_SHOW_USB_NOTIFICATION:I = 0x66
...
.field private static final MSG_USB_NOTIFICATION_SWITCH_DELAY:I = 0x68

.field private static final MSG_USER_SWITCHED:I = 0x5

.field private static final NET_LOCK:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field private static final USB_NOTIFICATION_HELP_MANUAL_ACTION:Ljava/lang/String; = "com.android.bbk_phoneInstructions_jump"
...
.field private mISUserRestrctions:Z

.field private mKeyGuardUnlockByUser:Z
...
.field private mRomVersionIsLower3_0:Z

.field private final mUEventObserver:Landroid/os/UEventObserver;

.field private mUsbAdbDebugIsOpen:Z

.field private mUsbAdbDebugTipsIsClickByUser:Z
...
.method static constructor <clinit>()V
    ...
    const-string v3, "persist.vivo.check_fast_charge"
    ...
    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_FAST_CHARGE_PROJECT:Z
    ...
    :goto_0
    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_ENG:Z
    ...
    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_LOG_CTRL_OPEN:Z

    .line 242
    const-string v0, "yes"

    const-string v3, "ro.vivo.net.entry"
    ...
    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_NET_ENTRY:Z
    ...
    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_NO_UMS:Z
    ...
    sput-object v0, Lcom/android/server/usb/UsbDeviceManager;->OP_ENTRY:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/usb/UsbDeviceManager;->NET_LOCK:Ljava/lang/String;

    .line 255
    sget-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_LOG_CTRL_OPEN:Z

    if-nez v0, :cond_1

    sget-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_ENG:Z
    ...
    :cond_2
    sput-boolean v1, Lcom/android/server/usb/UsbDeviceManager;->DEBUG:Z

    .line 257
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->ISDeviceRW()Z

    move-result v0

    sput-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->ISDEVICERW:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;)V
    ...
    .line 162
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mKeyGuardUnlockByUser:Z

    .line 169
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugTipsIsClickByUser:Z

    .line 170
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugIsOpen:Z
    ...
    .line 197
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mBootCompleted:Z
    ...
    .line 226
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mISUserRestrctions:Z

    .line 259
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mRomVersionIsLower3_0:Z
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mRomVersionIsLower3_0:Z
...
.method private static ISDeviceRW()Z
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    .line 2023
    .local v0, "isRW":Z
    sget-object v1, Lcom/android/server/usb/UsbDeviceManager;->OP_ENTRY:Ljava/lang/String;
    ...
    .line 2028
    :cond_1
    sget-boolean v1, Lcom/android/server/usb/UsbDeviceManager;->IS_LOG_CTRL_OPEN:Z
    ...
    const-string v3, "ISDeviceRW ro..entry:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-object v3, Lcom/android/server/usb/UsbDeviceManager;->OP_ENTRY:Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/server/usb/UsbDeviceManager;->NET_LOCK:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, " isRW:"
...
.method static synthetic access$1100()Z
    ...
    .prologue
    .line 106
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->isCmccRuWei()Z
...
.method static synthetic access$1200()Z
    ...
    .prologue
    .line 106
    sget-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->ISDEVICERW:Z

    return v0
.end method

.method static synthetic access$1300(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager;->logi(Ljava/lang/String;)V
...
.method static synthetic access$1800(Lcom/android/server/usb/UsbDeviceManager;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$1902(Lcom/android/server/usb/UsbDeviceManager;[Ljava/lang/String;)[Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # [Ljava/lang/String;
...
.method static synthetic access$2300(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$2600(Lcom/android/server/usb/UsbDeviceManager;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$2602(Lcom/android/server/usb/UsbDeviceManager;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # I
...
.method static synthetic access$2700(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mISUserRestrctions:Z
...
.method static synthetic access$2702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mISUserRestrctions:Z

    return p1
.end method

.method static synthetic access$2800(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager;->isAccessoryMode(Ljava/lang/String;)Z
...
.method static synthetic access$2900(Lcom/android/server/usb/UsbDeviceManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;

    .prologue
    .line 106
    invoke-direct {p0}, Lcom/android/server/usb/UsbDeviceManager;->processKeyGuardState()V
...
.method static synthetic access$3000()Z
    ...
    .prologue
    .line 106
    sget-boolean v0, Lcom/android/server/usb/UsbDeviceManager;->IS_FAST_CHARGE_PROJECT:Z

    return v0
.end method

.method static synthetic access$3100(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1, p2}, Lcom/android/server/usb/UsbDeviceManager;->logi(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$3200(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$3400(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mRomVersionIsLower3_0:Z
...
.method static synthetic access$3500(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    invoke-direct {p0}, Lcom/android/server/usb/UsbDeviceManager;->isUsbNotificationSoundEnabled()Z
...
.method static synthetic access$4000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Ljava/lang/String;
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1, p2}, Lcom/android/server/usb/UsbDeviceManager;->logd(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic access$4200(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugTipsIsClickByUser:Z
...
.method static synthetic access$4202(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugTipsIsClickByUser:Z
...
.method static synthetic access$4300(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugIsOpen:Z
...
.method static synthetic access$4302(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbAdbDebugIsOpen:Z
...
.method static synthetic access$500(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mKeyGuardUnlockByUser:Z
...
.method static synthetic access$502(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mKeyGuardUnlockByUser:Z

    return p1
.end method

.method static synthetic access$600(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager;->logd(Ljava/lang/String;)V
...
.method private isAccessoryMode(Ljava/lang/String;)Z
    .locals 1
...
.method private static isCmccRuWei()Z
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .line 2000
    :goto_0
    sget-boolean v1, Lcom/android/server/usb/UsbDeviceManager;->IS_ENG:Z
...
.method private isUsbNotificationSoundEnabled()Z
    .locals 4
    ...
    .line 2217
    .local v0, "result":Z
    const-string v2, "persist.sys.usb.notify.sound"
    ...
    .line 2218
    .local v1, "usbSoundProp":Ljava/lang/String;
    const-string v2, "1"
    ...
    const-string v3, "usb notification sound enabled ? "
    ...
    invoke-direct {p0, v2}, Lcom/android/server/usb/UsbDeviceManager;->logd(Ljava/lang/String;)V
...
.method private processKeyGuardState()V
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .prologue
    .line 2170
    iget-boolean v2, p0, Lcom/android/server/usb/UsbDeviceManager;->mBootCompleted:Z
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$4900(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    ...
    iput-boolean v2, p0, Lcom/android/server/usb/UsbDeviceManager;->mKeyGuardUnlockByUser:Z
    ...
    const-string v3, "processKeyGuardState locked:"
    ...
    iget-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mKeyGuardUnlockByUser:Z
    ...
    invoke-direct {p0, v2}, Lcom/android/server/usb/UsbDeviceManager;->logi(Ljava/lang/String;)V
    ...
    const-string v3, "processKeyGuardState configure:"
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mConfigured:Z
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$4900(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    ...
    const-string v3, " currentFunction:"
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mCurrentFunctions:Ljava/lang/String;
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$3600(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Ljava/lang/String;
...
.method private startAccessoryMode()V
    ...
    const-string v4, "checkAccessoryMode functions:"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/usb/UsbDeviceManager;->logi(Ljava/lang/String;)V
