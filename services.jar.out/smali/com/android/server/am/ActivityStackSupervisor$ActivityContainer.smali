...
.method attachToDisplayLocked(Lcom/android/server/am/ActivityStackSupervisor$ActivityDisplay;Landroid/graphics/Rect;)V
    ...
    .prologue
    .line 5278
    sget-boolean v0, Landroid/util/VivoSmartMultiWindowConfig;->DEBUG_ACTIVITYSTACKSUPERVISOR:Z

    if-eqz v0, :cond_0

    .line 5279
    sget-object v0, Landroid/util/VivoSmartMultiWindowConfig;->TAG_ACTIVITYSTACKSUPERVISOR:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lcom/android/server/wm/WindowManagerService;->attachStack(IILandroid/graphics/Rect;)V
...
.method onTaskListEmptyLocked()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->getAnotherStack(Lcom/android/server/am/ActivityStack;)Lcom/android/server/am/ActivityStack;

    move-result-object v0

    .line 5471
    .local v0, "anotherStack":Lcom/android/server/am/ActivityStack;
    sget-boolean v1, Landroid/util/VivoSmartMultiWindowConfig;->DEBUG_ACTIVITYSTACKSUPERVISOR:Z

    if-eqz v1, :cond_2

    .line 5472
    sget-object v1, Landroid/util/VivoSmartMultiWindowConfig;->TAG_ACTIVITYSTACKSUPERVISOR:Ljava/lang/String;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "onTaskListEmptyLocked anotherStack = "
    ...
    const-string v3, "onTaskListEmptyLocked mLastStackId = "
    ...
    # getter for: Lcom/android/server/am/ActivityStackSupervisor;->mLastStackId:I
    invoke-static {v3}, Lcom/android/server/am/ActivityStackSupervisor;->access$1100(Lcom/android/server/am/ActivityStackSupervisor;)I
    ...
    invoke-virtual {v1, p0}, Lcom/android/server/am/ActivityStackSupervisor;->deleteActivityContainer(Landroid/app/IActivityContainer;)V
    ...
    # getter for: Lcom/android/server/am/ActivityStackSupervisor;->mLastStackId:I
    invoke-static {v2}, Lcom/android/server/am/ActivityStackSupervisor;->access$1100(Lcom/android/server/am/ActivityStackSupervisor;)I
    ...
    # setter for: Lcom/android/server/am/ActivityStackSupervisor;->mLastStackId:I
    invoke-static {v1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->access$1102(Lcom/android/server/am/ActivityStackSupervisor;I)I
