...
.field static final MAX_CACHED_ACTIVITY_APPS:I
...
.field static final MAX_CACHED_EMPTY_APPS:I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field static final MAX_SERVICE_APPS:I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field static final RAMSIZE:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lcom/android/server/am/ProcessList;->computeCachedProcessLimit(I)I

    move-result v0

    sput v0, Lcom/android/server/am/ProcessList;->MAX_CACHED_ACTIVITY_APPS:I
    ...
    sput v0, Lcom/android/server/am/ProcessList;->MAX_CACHED_EMPTY_APPS:I
    ...
    sput v0, Lcom/android/server/am/ProcessList;->MAX_SERVICE_APPS:I

    .line 172
    invoke-static {}, Lcom/android/server/am/ProcessList;->computeDeviceRAMSIZE()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/server/am/ProcessList;->RAMSIZE:Ljava/lang/String;
...
.method private static computeCachedProcessLimit(I)I
    .locals 12
    .param p0, "appType"    # I
    .annotation runtime Landroid/annotation/VivoHook;
...
.method private static computeDeviceRAMSIZE()Ljava/lang/String;
    .locals 8
    ...
    .line 398
    const-string v1, "RAM6G"

    goto :goto_0

    .line 400
    :cond_5
    const-string v1, "RAMUNKNOW"
