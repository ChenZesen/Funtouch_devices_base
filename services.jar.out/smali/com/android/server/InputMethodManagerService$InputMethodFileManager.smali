...
.method public constructor <init>(Ljava/util/HashMap;I)V
    ...
    .line 4103
    const-string v3, "InputMethodManagerService_STATIC"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "[TAG_STATIC]Couldn\'t create dir.: "
...
.method private static readAdditionalInputMethodSubtypes(Ljava/util/HashMap;Landroid/util/AtomicFile;)V
    ...
    :try_start_1
    const-string v19, "InputMethodManagerService_STATIC"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string v21, "[TAG_STATIC]Error reading subtypes: "
    ...
    const-string v20, "[TAG_STATIC]Failed to close."
    ...
    const-string v20, "[TAG_STATIC]Invalid imi id found in subtypes.xml"
    ...
    const-string v21, "[TAG_STATIC]IME uninstalled or not valid.: "
    ...
    .line 4301
    .restart local v5    # "e1":Ljava/io/IOException;
    const-string v20, "InputMethodManagerService_STATIC"

    const-string v21, "[TAG_STATIC]Failed to close."
...
.method private static writeAdditionalInputMethodSubtypes(Ljava/util/HashMap;Landroid/util/AtomicFile;Ljava/util/HashMap;)V
    ...
    .line 4173
    const-string v10, "InputMethodManagerService_STATIC"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "[TAG_STATIC]IME uninstalled or not valid.: "
    ...
    const-string v11, "[TAG_STATIC]Error writing subtypes"
...
.method public addInputMethodSubtypes(Landroid/view/inputmethod/InputMethodInfo;[Landroid/view/inputmethod/InputMethodSubtype;)V
    ...
    .line 4139
    :cond_0
    const-string v4, "InputMethodManagerService_STATIC"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "[TAG_STATIC]Duplicated subtype definition found: "
