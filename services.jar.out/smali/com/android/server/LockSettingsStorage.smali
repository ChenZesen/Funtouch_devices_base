...
.field private static final LOCK_VISIT_PASSWORD_FILE:Ljava/lang/String; = "gatekeeper.visit_password.key"

.field private static final LOCK_VISIT_PATTERN_FILE:Ljava/lang/String; = "gatekeeper.visit_gesture.key"

.field private static final PASSWORD_STORED_FILE:Ljava/lang/String; = "password.stored.key"
...
.method getLockStoredFilename(I)Ljava/lang/String;
    .locals 1
    .param p1, "userId"    # I

    .prologue
    .line 672
    const-string v0, "password.stored.key"
...
.method getLockVisitPasswordFilename(I)Ljava/lang/String;
    .locals 1
    .param p1, "userId"    # I

    .prologue
    .line 643
    const-string v0, "gatekeeper.visit_password.key"
...
.method getLockVisitPatternFilename(I)Ljava/lang/String;
    .locals 1
    .param p1, "userId"    # I

    .prologue
    .line 639
    const-string v0, "gatekeeper.visit_gesture.key"
...
.method public readStoredHash(I)Lcom/android/server/LockSettingsStorage$CredentialHash;
    .locals 3
    .param p1, "userId"    # I

    .prologue
    .line 680
    invoke-virtual {p0, p1}, Lcom/android/server/LockSettingsStorage;->getLockStoredFilename(I)Ljava/lang/String;
...
.method public readVisitPasswordHash(I)Lcom/android/server/LockSettingsStorage$CredentialHash;
    .locals 3
    .param p1, "userId"    # I

    .prologue
    .line 647
    invoke-virtual {p0, p1}, Lcom/android/server/LockSettingsStorage;->getLockVisitPasswordFilename(I)Ljava/lang/String;
...
.method public readVisitPatternHash(I)Lcom/android/server/LockSettingsStorage$CredentialHash;
    .locals 3
    .param p1, "userId"    # I

    .prologue
    .line 655
    invoke-virtual {p0, p1}, Lcom/android/server/LockSettingsStorage;->getLockVisitPatternFilename(I)Ljava/lang/String;
...
.method public writeStoredHash([BI)V
    .locals 1
    .param p1, "hash"    # [B
    .param p2, "userId"    # I
    ...
    .prologue
    .line 676
    invoke-virtual {p0, p2}, Lcom/android/server/LockSettingsStorage;->getLockStoredFilename(I)Ljava/lang/String;
...
.method public writeVisitPasswordHash([BI)V
    .locals 1
    .param p1, "hash"    # [B
    .param p2, "userId"    # I
    ...
    .prologue
    .line 667
    invoke-virtual {p0, p2}, Lcom/android/server/LockSettingsStorage;->getLockVisitPasswordFilename(I)Ljava/lang/String;
...
.method public writeVisitPatternHash([BI)V
    .locals 1
    .param p1, "hash"    # [B
    .param p2, "userId"    # I
    ...
    .prologue
    .line 663
    invoke-virtual {p0, p2}, Lcom/android/server/LockSettingsStorage;->getLockVisitPatternFilename(I)Ljava/lang/String;
