...
.field private mRingingReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v4, p0, Lcom/android/server/policy/GlobalActions;->mRingingReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 167
    const-string v4, "com.android.service.hallobserver.lock"
...
.method static synthetic access$1700(Lcom/android/server/policy/GlobalActions;)Landroid/app/Dialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/GlobalActions;
...
.method static synthetic access$1702(Lcom/android/server/policy/GlobalActions;Landroid/app/Dialog;)Landroid/app/Dialog;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/policy/GlobalActions;
...
.method static synthetic access$2000(Lcom/android/server/policy/GlobalActions;)V
    ...
    .prologue
    .line 99
    invoke-direct {p0}, Lcom/android/server/policy/GlobalActions;->startQuickBoot()V
...
.method private createVivoRebootAndShutdownDialog()Landroid/app/Dialog;
    .locals 12
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/policy/GlobalActions$15;-><init>(Lcom/android/server/policy/GlobalActions;IIIII)V
    ...
    new-instance v7, Lcom/android/server/policy/VivoGlobalActionsDialog;

    .end local v7    # "dialog":Landroid/app/Dialog;
    iget-object v0, p0, Lcom/android/server/policy/GlobalActions;->mContext:Landroid/content/Context;

    invoke-direct {v7, v0}, Lcom/android/server/policy/VivoGlobalActionsDialog;-><init>(Landroid/content/Context;)V
    ...
    .line 1453
    check-cast v0, Lcom/android/server/policy/VivoGlobalActionsDialog;

    new-instance v1, Lcom/android/server/policy/GlobalActions$16;

    invoke-direct {v1, p0, v9}, Lcom/android/server/policy/GlobalActions$16;-><init>(Lcom/android/server/policy/GlobalActions;Z)V

    invoke-virtual {v0, v1}, Lcom/android/server/policy/VivoGlobalActionsDialog;->setCallback(Lcom/android/server/policy/VivoGlobalActionsDialog$IGlobalDialogCallback;)V
    ...
    iget-object v1, p0, Lcom/android/server/policy/GlobalActions;->mRingingReceiver:Landroid/content/BroadcastReceiver;
...
.method private handleShow()V
    ...
    const-string v2, "isUserAMonkey() = true"
    ...
    .line 230
    invoke-direct {p0}, Lcom/android/server/policy/GlobalActions;->createVivoRebootAndShutdownDialog()Landroid/app/Dialog;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/policy/GlobalActions;->mDialog:Landroid/app/Dialog;
...
.method private isNewShutdownUi()Z
    .locals 1
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget-object v2, p0, Lcom/android/server/policy/GlobalActions;->mRingingReceiver:Landroid/content/BroadcastReceiver;
...
.method public showDialog(ZZ)V
    ...
    const-string v2, "showDialog dialog is "
