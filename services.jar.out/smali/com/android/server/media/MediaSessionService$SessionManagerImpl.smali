...
.method private dispatchAdjustVolumeLocked(IIILcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->access$2500(Lcom/android/server/media/MediaSessionService;)Landroid/media/IAudioService;
...
.method private dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    const-string v4, "dispatchMediaKeyEventLocked :voice_steam is active :"
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mAudioService:Landroid/media/IAudioService;
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService;->access$2500(Lcom/android/server/media/MediaSessionService;)Landroid/media/IAudioService;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mAudioService:Landroid/media/IAudioService;
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$2500(Lcom/android/server/media/MediaSessionService;)Landroid/media/IAudioService;
    ...
    const-string v3, " we do nothing here  keycode since it is incall"
    ...
    const-string v3, "Error dispatchMediaKeyEventLocked getMode "
...
.method private handleVoiceKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mHeadsetLpressMode:I
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->access$2600(Lcom/android/server/media/MediaSessionService;)I
    ...
    .line 996
    :pswitch_0
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isSuperPowerSaverMode()Z
    ...
    .line 1000
    :pswitch_1
    invoke-direct {p0, p2}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->startVivoice(Z)V
...
.method private isSecureLocked()Z
    ...
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->access$3000(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
...
.method private isTelephonyIdle()Z
    .locals 3
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .line 1132
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->getTelecommService()Landroid/telecom/TelecomManager;
...
.method private isVivoiceLaunchable()Z
    ...
    const-string v2, "vivo_vivoice_launchable"
...
.method private performHapticFeedback()Z
    .locals 6
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mVibrator:Landroid/os/Vibrator;
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->access$3100(Lcom/android/server/media/MediaSessionService;)Landroid/os/Vibrator;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mVibrator:Landroid/os/Vibrator;
    invoke-static {v1}, Lcom/android/server/media/MediaSessionService;->access$3100(Lcom/android/server/media/MediaSessionService;)Landroid/os/Vibrator;

    move-result-object v1

    iget-object v3, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->this$0:Lcom/android/server/media/MediaSessionService;

    # getter for: Lcom/android/server/media/MediaSessionService;->mLongPressVibePattern:[J
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->access$3200(Lcom/android/server/media/MediaSessionService;)[J
...
.method private startVivoice(Z)V
    .locals 5
    ...
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isTelephonyIdle()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isSecureLocked()Z

    move-result v2

    if-nez v2, :cond_0

    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isVivoiceLaunchable()Z
    ...
    const-string v2, "vivo.intent.action.HEADSETHOOK_KEY_LONG_PRESS"

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1176
    .local v1, "intent":Landroid/content/Intent;
    const-string v2, "com.bbk.VoiceAssistant"
    ...
    .line 1180
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->performHapticFeedback()Z
    :try_end_0
    ...
    const-string v4, "No activity... for search: "
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v3}, Lcom/android/server/media/MediaSessionService;->access$2800(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
