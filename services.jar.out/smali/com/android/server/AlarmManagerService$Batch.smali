...
.method private checkAlarmIsSuitableForThisBatch(Lcom/android/server/AlarmManagerService$Alarm;)Z
    .locals 5
    ...
    .line 461
    .local v3, "targetPackgeAlarmCount":I
    if-eqz v2, :cond_1
...
.method private isAlarmPendingIntentCanceled(Lcom/android/server/AlarmManagerService$Alarm;)Z
    .locals 2
    ...
    invoke-static {v1}, Lcom/android/server/am/VivoActivityManagerServiceUtils;->isPendingIntentCanceled(Landroid/app/PendingIntent;)Z
...
.method add(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    .prologue
    .line 423
    invoke-direct {p0, p1}, Lcom/android/server/AlarmManagerService$Batch;->checkAlarmIsSuitableForThisBatch(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    const-string v4, "  has toomuch Alarm in  "
...
.method remove(Landroid/app/PendingIntent;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/AlarmManagerService$Batch;->isAlarmPendingIntentCanceled(Lcom/android/server/AlarmManagerService$Alarm;)Z
