...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/notification/ConditionProviders;)V
    ...
    invoke-direct {v0, p0, p3, v1}, Lcom/android/server/notification/ZenModeConditions;-><init>(Lcom/android/server/notification/ZenModeHelper;Lcom/android/server/notification/ConditionProviders;Landroid/os/Handler;)V
...
.method static synthetic access$1300(Lcom/android/server/notification/ZenModeHelper;)Landroid/service/notification/ZenModeConfig;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$1400(Lcom/android/server/notification/ZenModeHelper;)Landroid/util/SparseArray;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$1700(Lcom/android/server/notification/ZenModeHelper;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method static synthetic access$1800(Lcom/android/server/notification/ZenModeHelper;)Lcom/android/server/notification/ZenModeHelper$Metrics;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/ZenModeHelper;
...
.method private computeZenMode(Landroid/util/ArraySet;)I
    ...
    const-string v5, "DEBUG_ZENMODE:computeZenMode manualRule not none"
    ...
    const-string v5, "DEBUG_ZENMODE:computeZenMode checking rule:"
    ...
    const-string v5, "DEBUG_ZENMODE:computeZenMode got zen="
...
.method private static dump(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/service/notification/ZenModeConfig;)V
    ...
    .line 255
    :cond_1
    const-string v2, "allow(calls=%s,callsFrom=%s,repeatCallers=%s,messages=%s,messagesFrom=%s,events=%s,reminders=%s,groupid=%s)\n"
    ...
    iget-wide v6, p3, Landroid/service/notification/ZenModeConfig;->groupid:J
...
.method private evaluateZenMode(Ljava/lang/String;Z)Z
    ...
    const-string v3, "DEBUG_ZENMODE:evaluateZenMode"
    ...
    const-string v4, "DEBUG_ZENMODE: new zen="
...
.method private setConfig(Landroid/service/notification/ZenModeConfig;Ljava/lang/String;Z)Z
    ...
    const-string v5, "DEBUG_ZENMODE:setConfig reason="
    ...
    const-string v5, "DEBUG_ZENMODE:setConfig old config="
    ...
    const-string v4, "DEBUG_ZENMODE:Invalid config in setConfig; "
    ...
    const-string v4, "DEBUG_ZENMODE:setConfig has diff"
    ...
    const-string v5, "DEBUG_ZENMODE:setConfig policyChanged="
...
.method private setManualZenMode(ILandroid/net/Uri;Ljava/lang/String;Z)V
    ...
    const-string v6, "DEBUG_ZENMODE:setManualZenMode "
