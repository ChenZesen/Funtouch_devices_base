...
.method private static audienceMatches(IFLandroid/service/notification/ZenModeConfig;)Z
    .locals 6
    .param p0, "source"    # I
    ...
    const-string v4, "DEBUG_ZENMODE:audienceMatches source="
    ...
    const-string v4, "config.groupid="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-wide v4, p2, Landroid/service/notification/ZenModeConfig;->groupid:J
    ...
    .line 266
    :pswitch_2
    iget-wide v2, p2, Landroid/service/notification/ZenModeConfig;->groupid:J
...
.method public static matchesCallFilter(Landroid/content/Context;ILandroid/service/notification/ZenModeConfig;Landroid/os/UserHandle;Landroid/os/Bundle;Lcom/android/server/notification/ValidateNotificationPeople;IF)Z
    ...
    const-string v5, "DEBUG_ZENMODE:matchesCallFilter zen="
    ...
    const-string v3, "DEBUG_ZENMODE:matchesCallFilteralidator.getContactAffinity "
    ...
    invoke-static {v1, v0, p2}, Lcom/android/server/notification/ZenModeFiltering;->audienceMatches(IFLandroid/service/notification/ZenModeConfig;)Z
...
.method private static shouldInterceptAudience(ILcom/android/server/notification/NotificationRecord;Landroid/service/notification/ZenModeConfig;)Z
    .locals 1
    .param p0, "source"    # I
    .param p1, "record"    # Lcom/android/server/notification/NotificationRecord;
    .param p2, "config"    # Landroid/service/notification/ZenModeConfig;
    ...
    invoke-static {p0, v0, p2}, Lcom/android/server/notification/ZenModeFiltering;->audienceMatches(IFLandroid/service/notification/ZenModeConfig;)Z
...
.method public shouldIntercept(ILandroid/service/notification/ZenModeConfig;Lcom/android/server/notification/NotificationRecord;)Z
    ...
    invoke-static {v0, p3, p2}, Lcom/android/server/notification/ZenModeFiltering;->shouldInterceptAudience(ILcom/android/server/notification/NotificationRecord;Landroid/service/notification/ZenModeConfig;)Z
