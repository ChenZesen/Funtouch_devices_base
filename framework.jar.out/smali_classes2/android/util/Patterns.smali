...
.field private static final VIGOUR_DOMAIN_NAME:Ljava/util/regex/Pattern;

.field private static final VIGOUR_GOOD_IRI_CHAR:Ljava/lang/String; = "a-zA-Z0-9"

.field private static final VIGOUR_GTLD:Ljava/lang/String; = "[a-zA-Z]{2,63}"

.field private static final VIGOUR_GTLD_CHAR:Ljava/lang/String; = "a-zA-Z"

.field private static final VIGOUR_HOST_NAME:Ljava/lang/String; = "([a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9]){0,1}\\.)+[a-zA-Z]{2,63}"

.field private static final VIGOUR_IRI:Ljava/lang/String; = "[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9]){0,1}"

.field public static final VIGOUR_PHONE:Ljava/util/regex/Pattern;

.field public static final VIGOUR_PHONE_CN:Ljava/util/regex/Pattern;

.field public static final VIGOUR_WEB_URL:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "(([a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9]){0,1}\\.)+[a-zA-Z]{2,63}|"
    ...
    sput-object v0, Landroid/util/Patterns;->VIGOUR_DOMAIN_NAME:Ljava/util/regex/Pattern;
    ...
    sget-object v1, Landroid/util/Patterns;->VIGOUR_DOMAIN_NAME:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Landroid/util/Patterns;->VIGOUR_WEB_URL:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Landroid/util/Patterns;->VIGOUR_PHONE:Ljava/util/regex/Pattern;

    .line 300
    const-string v0, "((?<![0-9])([0-9]{3,4} [0-9]{7,8})(?![0-9]))|((?<![0-9])([0-9]{3}( [0-9]{4}){2})(?![0-9]))"

    invoke-static {v0}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Landroid/util/Patterns;->VIGOUR_PHONE_CN:Ljava/util/regex/Pattern;
