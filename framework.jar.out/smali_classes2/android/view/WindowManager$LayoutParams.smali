...
.field public static final PRIVATE_FLAG_DISABLE_HOMEKEY_LONGPRESS:I = 0x40000000
...
.field public static final PRIVATE_FLAG_HOMEKEY_DISPATCHED:I = 0x20000000
    .annotation runtime Landroid/annotation/VivoHook;
...
.field public mAppOwnStatusBarBg:I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field public statusbarIconColor:I

.field public statusbarVisible:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    .line 1412
    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    .line 1415
    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I
    ...
    .line 1499
    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
...
.method public constructor <init>(IIIII)V
    ...
    .line 1412
    iput v5, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    .line 1410
    iput v1, p0, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    .line 1412
    const/4 v0, -0x1

    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    .line 1415
    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I
    ...
    .line 1499
    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I
    ...
    iput v0, p0, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
...
.method public final copyFrom(Landroid/view/WindowManager$LayoutParams;)I
    ...
    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->statusbarColor:I

    if-eq v2, v3, :cond_23

    .line 1996
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->statusbarColor:I

    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarColor:I

    .line 1998
    :cond_23
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    if-eq v2, v3, :cond_24

    .line 2000
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    .line 2002
    :cond_24
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    if-eq v2, v3, :cond_25

    .line 2003
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    .line 2005
    :cond_25
    iget v2, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I

    iget v3, p1, Landroid/view/WindowManager$LayoutParams;->traditonToast:I

    if-eq v2, v3, :cond_26

    .line 2006
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->traditonToast:I

    iput v2, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I

    .line 2010
    :cond_26
    iget v2, p1, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
...
.method public final setAppOwnStatusBarBg(I)V
    .locals 0
    .param p1, "enable"    # I
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    .prologue
    .line 2198
    iput p1, p0, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 1724
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->statusbarVisible:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 1725
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->statusbarIconColor:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 1727
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->traditonToast:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 1730
    iget v0, p0, Landroid/view/WindowManager$LayoutParams;->mAppOwnStatusBarBg:I
