...
.field private mEadgeReached:Z

.field private mLastFlingY:I

.field private final mScroller:Landroid/widget/OverScrollerProxy;
...
.method constructor <init>(Landroid/widget/AbsListView;)V
    ...
    iput-boolean v0, p0, Landroid/widget/AbsListView$FlingRunnable;->mEadgeReached:Z
    ...
    .line 4670
    new-instance v1, Landroid/widget/OverScrollerProxy;

    # getter for: Landroid/widget/AbsListView;->mEnableSpringEffect:Z
    invoke-static {p1}, Landroid/widget/AbsListView;->access$1800(Landroid/widget/AbsListView;)Z
    ...
    invoke-direct {v1, v0, v2}, Landroid/widget/OverScrollerProxy;-><init>(ILandroid/content/Context;)V

    iput-object v1, p0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;
...
.method static synthetic access$1600(Landroid/widget/AbsListView$FlingRunnable;)Landroid/widget/OverScrollerProxy;
    .locals 1
    .param p0, "x0"    # Landroid/widget/AbsListView$FlingRunnable;

    .prologue
    .line 4616
    iget-object v0, p0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;
...
.method edgeReached(I)V
    ...
    .line 4717
    iget-object v2, p0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;
    ...
    invoke-virtual {v2, v3, v4, v5}, Landroid/widget/OverScrollerProxy;->notifyVerticalEdgeReached(III)V
    ...
    .line 4723
    iput-boolean v6, p0, Landroid/widget/AbsListView$FlingRunnable;->mEadgeReached:Z

    .line 4725
    iget-object v2, p0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;

    invoke-virtual {v2}, Landroid/widget/OverScrollerProxy;->getCurrVelocity()F
...
.method endFling()V
    ...
    invoke-virtual {v0}, Landroid/widget/OverScrollerProxy;->abortAnimation()V
...
.method public run()V
    ...
    iget-object v2, v0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;

    invoke-virtual {v2}, Landroid/widget/OverScrollerProxy;->isFinished()Z
    ...
    iget-object v0, v0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;

    move-object/from16 v27, v0

    .line 4795
    .local v27, "scroller":Landroid/widget/OverScrollerProxy;
    invoke-virtual/range {v27 .. v27}, Landroid/widget/OverScrollerProxy;->computeScrollOffset()Z

    move-result v23

    .line 4796
    .local v23, "more":Z
    invoke-virtual/range {v27 .. v27}, Landroid/widget/OverScrollerProxy;->getCurrY()I
    ...
    .end local v24    # "motionView":Landroid/view/View;
    .end local v26    # "oldTop":I
    .end local v27    # "scroller":Landroid/widget/OverScrollerProxy;
    .end local v29    # "y":I
    :pswitch_3
    move-object/from16 v0, p0
    ...
    .line 4875
    .restart local v27    # "scroller":Landroid/widget/OverScrollerProxy;
    invoke-virtual/range {v27 .. v27}, Landroid/widget/OverScrollerProxy;->computeScrollOffset()Z
    ...
    iget v13, v2, Landroid/widget/AbsListView;->mOverscrollDistance:I
    ...
    .line 4890
    :cond_b
    invoke-virtual/range {v27 .. v27}, Landroid/widget/OverScrollerProxy;->getCurrVelocity()F
    ...
    iget-boolean v2, v0, Landroid/widget/AbsListView$FlingRunnable;->mEadgeReached:Z

    if-nez v2, :cond_0

    .line 4899
    invoke-virtual/range {v27 .. v27}, Landroid/widget/OverScrollerProxy;->abortAnimation()V
    ...
    iput-boolean v2, v0, Landroid/widget/AbsListView$FlingRunnable;->mEadgeReached:Z
...
.method start(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/widget/OverScrollerProxy;->setInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/widget/OverScrollerProxy;->fling(IIIIIIII)V
...
.method startOverfling(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/widget/OverScrollerProxy;->setInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/widget/OverScrollerProxy;->fling(IIIIIIIIII)V
...
.method startScroll(IIZ)V
    ...
    .line 4744
    iget-object v3, p0, Landroid/widget/AbsListView$FlingRunnable;->mScroller:Landroid/widget/OverScrollerProxy;
    ...
    :goto_1
    invoke-virtual {v3, v0}, Landroid/widget/OverScrollerProxy;->setInterpolator(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/widget/OverScrollerProxy;->startScroll(IIIII)V
...
.method startSpringback()V
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/widget/OverScrollerProxy;->springBack(IIIIII)Z
