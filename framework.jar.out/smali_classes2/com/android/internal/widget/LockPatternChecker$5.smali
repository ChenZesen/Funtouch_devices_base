...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/internal/widget/LockPatternChecker;->verifyVisitModePattern(Lcom/android/internal/widget/LockPatternUtils;Ljava/util/List;JILcom/android/internal/widget/LockPatternChecker$OnVerifyCallback;)Landroid/os/AsyncTask;
.end annotation
...
.method constructor <init>(Lcom/android/internal/widget/LockPatternUtils;Ljava/util/List;JILcom/android/internal/widget/LockPatternChecker$OnVerifyCallback;)V
    ...
    iput-object p2, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$pattern:Ljava/util/List;

    iput-wide p3, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$challenge:J

    iput p5, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$userId:I

    iput-object p6, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$callback:Lcom/android/internal/widget/LockPatternChecker$OnVerifyCallback;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/widget/LockPatternChecker$5;->doInBackground([Ljava/lang/Void;)[B
...
.method protected varargs doInBackground([Ljava/lang/Void;)[B
    ...
    iget-object v2, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$pattern:Ljava/util/List;

    iget-wide v4, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$challenge:J

    iget v3, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$userId:I

    invoke-virtual {v1, v2, v4, v5, v3}, Lcom/android/internal/widget/LockPatternUtils;->verifyVisitModePattern(Ljava/util/List;JI)[B
    :try_end_0
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    .end local p1    # "x0":Ljava/lang/Object;
    invoke-virtual {p0, p1}, Lcom/android/internal/widget/LockPatternChecker$5;->onPostExecute([B)V
...
.method protected onPostExecute([B)V
    ...
    .prologue
    .line 208
    iget-object v0, p0, Lcom/android/internal/widget/LockPatternChecker$5;->val$callback:Lcom/android/internal/widget/LockPatternChecker$OnVerifyCallback;
