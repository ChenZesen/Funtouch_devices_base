...
.method public static ucs2ToAlphaField([BIII)[B
    ...
    .line 716
    .local v15, "sCSTCount":I
    sget-object v18, Lcom/android/internal/telephony/GsmAlphabet;->sCharsToGsmTables:[Landroid/util/SparseIntArray;
    ...
    sget-object v18, Lcom/android/internal/telephony/GsmAlphabet;->sCharsToShiftTables:[Landroid/util/SparseIntArray;
    ...
    invoke-virtual {v7, v5, v0}, Landroid/util/SparseIntArray;->get(II)I
    ...
    .line 775
    and-int/lit16 v12, v12, 0x7f80

    .line 776
    add-int/lit8 v18, p3, 0x2

    shr-int/lit8 v19, v12, 0x7
    ...
    .line 808
    .local v4, "c":C
    invoke-static {v4}, Lcom/android/internal/telephony/GsmAlphabet;->isGsmSeptets(C)Z
    ...
    invoke-virtual {v7, v4, v0}, Landroid/util/SparseIntArray;->get(II)I
    ...
    invoke-static {v0, v1, v8, v2, v3}, Ljava/lang/System;->arraycopy([BI[BII)V

    move-object v9, v8

    .line 847
    .end local v8    # "dest":[B
    .restart local v9    # "dest":[B
    goto :goto_6
