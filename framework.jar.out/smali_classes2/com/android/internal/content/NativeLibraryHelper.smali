...
.field private static mSoCrcTable:Landroid/util/ArrayMap;
...
.method static synthetic access$002(Landroid/util/ArrayMap;)Landroid/util/ArrayMap;
    .locals 0
    .param p0, "x0"    # Landroid/util/ArrayMap;

    .prologue
    .line 58
    sput-object p0, Lcom/android/internal/content/NativeLibraryHelper;->mSoCrcTable:Landroid/util/ArrayMap;
...
.method public static getApksoCrcFromNative(Ljava/lang/String;)J
    .locals 4
    .param p0, "soDir"    # Ljava/lang/String;

    .prologue
    const-wide/16 v2, -0x1

    .line 182
    sget-object v1, Lcom/android/internal/content/NativeLibraryHelper;->mSoCrcTable:Landroid/util/ArrayMap;
    ...
    .line 185
    invoke-virtual {v0}, Landroid/content/pm/PackageSoCrcInfo$CrcCheckInfo;->getCrcValue()J
...
.method public static updateApksoCrcFromNative(Ljava/lang/String;J)V
    .locals 3
    .param p0, "soDir"    # Ljava/lang/String;
    .param p1, "crc"    # J
    ...
    .prologue
    .line 195
    sget-object v2, Lcom/android/internal/content/NativeLibraryHelper;->mSoCrcTable:Landroid/util/ArrayMap;
    ...
    invoke-direct {v0, p1, p2, v2}, Landroid/content/pm/PackageSoCrcInfo$CrcCheckInfo;-><init>(JZ)V
