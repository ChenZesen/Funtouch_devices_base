...
.method protected getDefaultView()Landroid/view/View;
    ...
    iget-object v10, v10, Landroid/appwidget/AppWidgetProviderInfo;->providerInfo:Landroid/content/pm/ActivityInfo;

    iget-object v10, v10, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget v10, v10, Landroid/content/pm/ApplicationInfo;->theme:I

    invoke-static {v10}, Lvivo/util/VivoThemeUtil;->isVigourThemeRaw(I)Z
    ...
    .line 561
    iget-object v10, p0, Landroid/appwidget/AppWidgetHostView;->mRemoteContext:Landroid/content/Context;

    iget-object v11, p0, Landroid/appwidget/AppWidgetHostView;->mInfo:Landroid/appwidget/AppWidgetProviderInfo;

    iget-object v11, v11, Landroid/appwidget/AppWidgetProviderInfo;->providerInfo:Landroid/content/pm/ActivityInfo;

    iget-object v11, v11, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget v11, v11, Landroid/content/pm/ApplicationInfo;->theme:I
    ...
    invoke-static {v9, v10}, Landroid/appwidget/FtAppWidgetContext;->newWidgetContext(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)Landroid/content/Context;

    move-result-object v10

    invoke-virtual {v4, v10}, Landroid/view/LayoutInflater;->cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;
...
.method public updateAppWidget(Landroid/widget/RemoteViews;)V
    ...
    .line 376
    iget v6, p0, Landroid/appwidget/AppWidgetHostView;->mViewMode:I
    ...
    iput v6, p0, Landroid/appwidget/AppWidgetHostView;->mLayoutId:I
    ...
    const-string/jumbo v7, "updateAppWidget couldn\'t find any view, using error view"
    ...
    invoke-virtual {p0, v6}, Landroid/appwidget/AppWidgetHostView;->removeView(Landroid/view/View;)V
    ...
    iput-object v6, p0, Landroid/appwidget/AppWidgetHostView;->mRemoteContext:Landroid/content/Context;
    ...
    iget v6, p0, Landroid/appwidget/AppWidgetHostView;->mLayoutId:I
    ...
    iget-object v8, p0, Landroid/appwidget/AppWidgetHostView;->mOnClickHandler:Landroid/widget/RemoteViews$OnClickHandler;

    invoke-virtual {p1, v6, v7, v8}, Landroid/widget/RemoteViews;->reapply(Landroid/content/Context;Landroid/view/View;Landroid/widget/RemoteViews$OnClickHandler;)V
    ...
    invoke-static {v6, v7}, Landroid/appwidget/FtAppWidgetContext;->newWidgetContext(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)Landroid/content/Context;
    ...
    invoke-virtual {p1, v1, p0, v6}, Landroid/widget/RemoteViews;->apply(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/widget/RemoteViews$OnClickHandler;)Landroid/view/View;
    :try_end_1
    ...
    :cond_6
    :goto_3
    iput v4, p0, Landroid/appwidget/AppWidgetHostView;->mLayoutId:I
