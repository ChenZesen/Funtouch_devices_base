...
.field public static final START_VIVO_PERMISSION_DENIED:I = 0x190
...
.method public addPreloadProcess(Ljava/lang/String;)Z
    .locals 2
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/app/ActivityManager;->addPreloadProcess(Ljava/lang/String;J)Z
...
.method public addPreloadProcess(Ljava/lang/String;J)Z
    .locals 2
    .param p1, "procName"    # Ljava/lang/String;
    .param p2, "delay"    # J
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/app/IActivityManager;->addPreloadProcess(Ljava/lang/String;J)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public clearApplicationUserData()Z
    ...
    invoke-virtual {p0, v0, v2, v1}, Landroid/app/ActivityManager;->clearApplicationUserData(Ljava/lang/String;Landroid/content/pm/IPackageDataObserver;I)Z
    ...
    invoke-virtual {p0, v0, v2}, Landroid/app/ActivityManager;->clearApplicationUserData(Ljava/lang/String;Landroid/content/pm/IPackageDataObserver;)Z
...
.method public removePreloadProcess(Ljava/lang/String;)Z
    .locals 2
    .param p1, "procName"    # Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/app/ActivityManager;->removePreloadProcess(Ljava/lang/String;J)Z
...
.method public removePreloadProcess(Ljava/lang/String;J)Z
    .locals 2
    .param p1, "procName"    # Ljava/lang/String;
    .param p2, "delay"    # J
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/app/IActivityManager;->removePreloadProcess(Ljava/lang/String;J)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
