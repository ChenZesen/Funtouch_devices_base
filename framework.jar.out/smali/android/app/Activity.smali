...
.field private mSpecialActivity:Z
...
.method public constructor <init>()V
    ...
    .line 802
    iput-boolean v1, p0, Landroid/app/Activity;->mSpecialActivity:Z
...
.method private decideSpecialActivity()V
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    .line 6856
    const-string v2, "com.android.VideoPlayer.MovieViewPublicActivity"
    ...
    const-string v2, "com.android.VideoPlayer.MovieViewActivity"
    ...
    .line 6857
    :cond_2
    iput-boolean v3, p0, Landroid/app/Activity;->mSpecialActivity:Z
...
.method private getActivityContextImpl()Landroid/app/ContextImpl;
    .locals 3
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    instance-of v2, v0, Landroid/app/ContextImpl;
...
.method private setSplitDiplayInfo()V
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .line 6776
    .local v2, "mVivoMultiWindowMgr":Landroid/app/VivoSmartMultiWindowManager;
    const/4 v1, 0x0
    ...
    .line 6778
    invoke-virtual {v2}, Landroid/app/VivoSmartMultiWindowManager;->getSplitDisplayInfo()[F

    move-result-object v1

    .line 6780
    :cond_0
    invoke-virtual {p0, v1}, Landroid/app/Activity;->setSplitDisplayInfo([F)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 6784
    .end local v1    # "info":[F
    .end local v2    # "mVivoMultiWindowMgr":Landroid/app/VivoSmartMultiWindowManager;
    :goto_0
    return-void
...
.method private updateSplitCurrentRotation(I)V
    .locals 3
    .param p1, "rotation"    # I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    ...
    .line 6808
    :goto_1
    invoke-virtual {p0, v1}, Landroid/app/Activity;->setSplitCurrentRotation(I)V
...
.method public moveTaskToBack(Z)Z
    ...
    const-string/jumbo v2, "moveTaskToBack failed"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 944
    invoke-direct {p0}, Landroid/app/Activity;->decideSpecialActivity()V
...
.method final performResume(ZZ)V
    .locals 3
    .param p1, "paused"    # Z
    .param p2, "stopped"    # Z
    .annotation runtime Landroid/annotation/VivoHook;
    ...
    iget-boolean v1, p0, Landroid/app/Activity;->mSpecialActivity:Z
...
.method public setSplitCurrentRotation(I)V
    ...
    .prologue
    .line 6815
    iget-object v1, p0, Landroid/app/Activity;->mWindowManager:Landroid/view/WindowManager;
    ...
    invoke-interface {v1, p1}, Landroid/view/WindowManager;->setSplitCurrentRotation(I)V

    .line 6819
    :cond_0
    invoke-direct {p0}, Landroid/app/Activity;->getActivityContextImpl()Landroid/app/ContextImpl;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {v0, p1}, Landroid/app/ContextImpl;->setSplitCurrentRotation(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSplitDisplayInfo([F)V
    ...
    invoke-interface {v1, p1}, Landroid/view/WindowManager;->setSplitDiplayInfo([F)V
    ...
    .line 6844
    invoke-virtual {v0, p1}, Landroid/app/ContextImpl;->setSplitDisplayInfo([F)V
...
.method final updateStackOritationByActivity()V
    .locals 3
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    .line 6763
    :try_start_0
    const-string/jumbo v2, "vivosmartmultiwindowservice"
    ...
    .line 6764
    .local v1, "mVivoMultiWindowMgr":Landroid/app/VivoSmartMultiWindowManager;
    if-eqz v1, :cond_0

    .line 6765
    iget-object v2, p0, Landroid/app/Activity;->mToken:Landroid/os/IBinder;

    invoke-virtual {v1, v2}, Landroid/app/VivoSmartMultiWindowManager;->updateStackOritationByActivity(Landroid/os/IBinder;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 6770
    .end local v1    # "mVivoMultiWindowMgr":Landroid/app/VivoSmartMultiWindowManager;
    :cond_0
    :goto_0
    return-void
