...
.field private mVivoPreferenceManager:Landroid/preference/VivoPreferenceManager;
...
.method public bind(Landroid/widget/ListView;)V
    ...
    .line 168
    iget-object v0, p0, Landroid/preference/PreferenceScreen;->mVivoPreferenceManager:Landroid/preference/VivoPreferenceManager;

    if-nez v0, :cond_0

    .line 170
    new-instance v0, Landroid/preference/VivoPreferenceManager;

    invoke-direct {v0, p0}, Landroid/preference/VivoPreferenceManager;-><init>(Landroid/preference/PreferenceGroup;)V

    iput-object v0, p0, Landroid/preference/PreferenceScreen;->mVivoPreferenceManager:Landroid/preference/VivoPreferenceManager;

    .line 172
    :cond_0
    iget-object v0, p0, Landroid/preference/PreferenceScreen;->mVivoPreferenceManager:Landroid/preference/VivoPreferenceManager;

    invoke-virtual {v0, p1}, Landroid/preference/VivoPreferenceManager;->bindList(Landroid/widget/ListView;)V
...
.method protected onCreateRootAdapter()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v0}, Landroid/preference/VivoPreferenceManager;->getPreferenceGroupAdapter()Landroid/widget/ListAdapter;
