...
.field public static CTS_CTSV_MAG2ACC:I = 0x0
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/hardware/SensorManager;->CTS_CTSV_MAG2ACC:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
...
.method public getDefaultSensor(I)Landroid/hardware/Sensor;
    ...
    .line 496
    .local v1, "isCtsVerifierTest":Z
    invoke-virtual {p0}, Landroid/hardware/SensorManager;->isCtsVerifier()Z
    ...
    .line 500
    sput v10, Landroid/hardware/SensorManager;->CTS_CTSV_MAG2ACC:I
    ...
    const-string/jumbo v8, "sensorCTSV getDefaultSensor type TYPE_MAGNETIC_FIELD,force set type to1"
    ...
    iget v7, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
    ...
    const-string/jumbo v9, "sensorCTSV getDefaultSensor.int type is "
    ...
    const-string v9, " CTSV open RV sensor"
    ...
    iget v6, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
    ...
    .line 535
    :cond_6
    sget v6, Landroid/hardware/SensorManager;->CTS_CTSV_MAG2ACC:I

    invoke-virtual {v3, v6}, Landroid/hardware/Sensor;->setType(I)Z
    ...
    .end local v2    # "l":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/Sensor;>;"
    .end local v5    # "wakeUpSensor":Z
    :cond_8
    if-ne p1, v11, :cond_0

    .line 504
    sput v11, Landroid/hardware/SensorManager;->CTS_CTSV_MAG2ACC:I

    goto/16 :goto_0

    .line 527
    .restart local v0    # "i$":Ljava/util/Iterator;
    .restart local v2    # "l":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/Sensor;>;"
    .restart local v3    # "sensor":Landroid/hardware/Sensor;
    .restart local v4    # "str":Ljava/lang/String;
    .restart local v5    # "wakeUpSensor":Z
    :cond_9
    const-string v7, "SensorManager"
    ...
    const-string/jumbo v9, "sensorCTSV getDefaultSensor. name is "
...
.method public getSensorList(I)Ljava/util/List;
    ...
    .line 450
    .restart local v1    # "i":Landroid/hardware/Sensor;
    invoke-virtual {v1}, Landroid/hardware/Sensor;->getType()I
    ...
    const-string/jumbo v7, "sensorCTSV getDefaultSensor not all. type is "
    ...
    .line 457
    iget v4, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
    ...
    const-string v7, " CTSV open RV sensor"
...
.method public getSensors()I
    ...
    const-string/jumbo v1, "sensorCTSV LSensor is SENSOR_ACCELEROMETER|SENSOR_MAGNETIC_FIELD"
...
.method protected isCtsVerifier()Z
    .locals 6
    ...
    .line 713
    .local v2, "res":Z
    invoke-virtual {p0}, Landroid/hardware/SensorManager;->getContext()Landroid/content/Context;

    move-result-object v1

    .line 714
    .local v1, "mContextImpl":Landroid/content/Context;
    if-eqz v1, :cond_1
    ...
    const-string v3, "com.android.cts.hardware"
    ...
    iput v3, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
    ...
    const-string/jumbo v5, "sensorCTSV isCtsVerifier true CTS_CTSV_flag is"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Landroid/hardware/SensorManager;->CTS_CTSV_flag:I
    ...
    const-string/jumbo v4, "sensorCTSV isCtsVerifier false"
