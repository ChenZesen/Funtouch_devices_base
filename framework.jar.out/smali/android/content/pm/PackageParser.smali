...
# instance fields
.field private final HOME_CATEGORY:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field private final INPUT_ACTION:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field private final LIVEWALLPAPER_ACTION:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field private final WIDGET_ACTION:Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/content/pm/PackageParser;->INPUT_ACTION:Ljava/lang/String;

    .line 364
    const-string v0, "android.service.wallpaper.WallpaperService"

    iput-object v0, p0, Landroid/content/pm/PackageParser;->LIVEWALLPAPER_ACTION:Ljava/lang/String;

    .line 370
    const-string v0, "android.appwidget.action.APPWIDGET_UPDATE"

    iput-object v0, p0, Landroid/content/pm/PackageParser;->WIDGET_ACTION:Ljava/lang/String;

    .line 376
    const-string v0, "android.intent.category.HOME"

    iput-object v0, p0, Landroid/content/pm/PackageParser;->HOME_CATEGORY:Ljava/lang/String;
...
.method public static initLimitVal()V
    ...
    sput-boolean v0, Landroid/content/pm/PackageParser;->limitApp:Z
...
.method public static isLimitApp()Z
    .locals 4
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->PUBLIC_API_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    const-string/jumbo v3, "now get limitApp value is :  "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-boolean v3, Landroid/content/pm/PackageParser;->limitApp:Z
    ...
    .line 4320
    sget-boolean v0, Landroid/content/pm/PackageParser;->limitApp:Z

    .line 4321
    .local v0, "isLimit":Z
    const/4 v1, 0x0

    sput-boolean v1, Landroid/content/pm/PackageParser;->limitApp:Z
...
.method private parseBaseApk(Ljava/io/File;Landroid/content/res/AssetManager;I)Landroid/content/pm/PackageParser$Package;
    ...
    .line 924
    .local v30, "res":Landroid/content/res/VivoResources;
    const/16 v28, 0x0

    .line 928
    .local v28, "parser":Landroid/content/res/XmlResourceParser;
    :try_start_0
    new-instance v31, Landroid/content/res/VivoResources;
    ...
    invoke-direct {v0, v1, v5, v6}, Landroid/content/res/VivoResources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    :try_end_0
    ...
    .line 930
    .end local v30    # "res":Landroid/content/res/VivoResources;
    .local v31, "res":Landroid/content/res/VivoResources;
    const/4 v6, 0x0
    ...
    .line 949
    .end local v31    # "res":Landroid/content/res/VivoResources;
    .local v25, "e":Landroid/content/pm/PackageParser$PackageParserException;
    .restart local v30    # "res":Landroid/content/res/VivoResources;
    :goto_0
    :try_start_2
    throw v25
    :try_end_2
    ...
    .restart local v31    # "res":Landroid/content/res/VivoResources;
    :cond_1
    :try_start_3
    move-object/from16 v0, v32
...
.method private parseIntent(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;ZZLandroid/content/pm/PackageParser$IntentInfo;[Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v4, v12}, Landroid/content/pm/PackageParser;->toJudgeAppCategory(Ljava/lang/String;Ljava/lang/String;)V
...
.method private parseSplitApk(Landroid/content/pm/PackageParser$Package;ILandroid/content/res/AssetManager;I)V
    ...
    .line 974
    .local v26, "res":Landroid/content/res/VivoResources;
    const/16 v25, 0x0

    .line 978
    .local v25, "parser":Landroid/content/res/XmlResourceParser;
    :try_start_0
    new-instance v27, Landroid/content/res/VivoResources;
    ...
    invoke-direct {v0, v1, v3, v4}, Landroid/content/res/VivoResources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    :try_end_0
    ...
    .line 980
    .end local v26    # "res":Landroid/content/res/VivoResources;
    .local v27, "res":Landroid/content/res/VivoResources;
    const/4 v4, 0x0
    ...
    .line 992
    .end local v27    # "res":Landroid/content/res/VivoResources;
    .local v24, "e":Landroid/content/pm/PackageParser$PackageParserException;
    .restart local v26    # "res":Landroid/content/res/VivoResources;
    :goto_0
    :try_start_3
    throw v24
    :try_end_3
    ...
    .restart local v27    # "res":Landroid/content/res/VivoResources;
    :cond_0
    invoke-static {v6}, Llibcore/io/IoUtils;->closeQuietly(Ljava/lang/AutoCloseable;)V
...
.method private toJudgeAppCategory(Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    ...
    .line 4335
    sput-boolean v3, Landroid/content/pm/PackageParser;->limitApp:Z
    ...
    iget-object v0, p0, Landroid/content/pm/PackageParser;->mParseActivityArgs:Landroid/content/pm/PackageParser$ParseComponentArgs;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/content/pm/PackageParser;->mParseActivityArgs:Landroid/content/pm/PackageParser$ParseComponentArgs;

    iget-object v0, v0, Landroid/content/pm/PackageParser$ParseComponentArgs;->tag:Ljava/lang/String;
