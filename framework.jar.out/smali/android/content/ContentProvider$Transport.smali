...
.method private enforceReadPermission(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)I
    ...
    invoke-virtual {v7, p2, p1, p3}, Landroid/content/ContentProvider;->enforceReadPermissionInner(Landroid/net/Uri;Ljava/lang/String;Landroid/os/IBinder;)I
    ...
    :cond_0
    iget v7, p0, Landroid/content/ContentProvider$Transport;->mReadOp:I
    ...
    .line 522
    iget-object v7, p0, Landroid/content/ContentProvider$Transport;->mAppOpsManager:Landroid/app/AppOpsManager;

    iget v8, p0, Landroid/content/ContentProvider$Transport;->mReadOp:I

    invoke-virtual {v7, v8, p1}, Landroid/app/AppOpsManager;->noteProxyOp(ILjava/lang/String;)I
    ...
    .line 528
    .local v1, "componentPerm":Ljava/lang/String;
    if-nez v1, :cond_2
    ...
    invoke-static {v7}, Lcom/vivo/services/security/client/VivoPermissionManager;->checkCallingVivoPermission(Ljava/lang/String;)Z
    ...
    const-string v7, "content://mms-sms/threadID"
...
.method private enforceWritePermission(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)I
    ...
    invoke-virtual {v9, p2, p1, p3}, Landroid/content/ContentProvider;->enforceWritePermissionInner(Landroid/net/Uri;Ljava/lang/String;Landroid/os/IBinder;)I
    ...
    .line 576
    .local v3, "isWriteSmsIgnored":Z
    iget v9, p0, Landroid/content/ContentProvider$Transport;->mWriteOp:I
    ...
    # invokes: Landroid/content/ContentProvider;->isVivoInternalPackage(Ljava/lang/String;)Z
    invoke-static {p1}, Landroid/content/ContentProvider;->access$200(Ljava/lang/String;)Z
    ...
    .line 583
    :cond_1
    iget-object v9, p0, Landroid/content/ContentProvider$Transport;->mAppOpsManager:Landroid/app/AppOpsManager;

    iget v10, p0, Landroid/content/ContentProvider$Transport;->mWriteOp:I

    invoke-virtual {v9, v10, p1}, Landroid/app/AppOpsManager;->noteProxyOp(ILjava/lang/String;)I
    ...
    .end local v1    # "componentPerm":Ljava/lang/String;
    ...
    .end local v5    # "result":I
    .restart local v1    # "componentPerm":Ljava/lang/String;
    :cond_4
    move v4, v7
    ...
    invoke-static {v9}, Lcom/vivo/services/security/client/VivoPermissionManager;->checkCallingVivoPermission(Ljava/lang/String;)Z
    ...
    const-string v9, "content://mms-sms/threadID"
    ...
    invoke-static {v9}, Landroid/content/ContentProvider;->access$300(Landroid/content/ContentProvider;)Landroid/content/Context;
    ...
    const-string v11, "enforceWritePermission:OP_WRITE_SMS===>callingPkg: "
    ...
    const-string v11, ", defaultSmsApplication: "
    ...
    .line 642
    .end local v2    # "defaultSmsApplication":Ljava/lang/String;
    :cond_c
    if-eqz v3, :cond_d
