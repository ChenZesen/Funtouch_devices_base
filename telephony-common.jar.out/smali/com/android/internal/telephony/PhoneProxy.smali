...
.field protected static final EVENT_UI_NOT_READY:I = 0x64
...
.field private static final sCtPlmn:[Ljava/lang/String;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/PhoneProxy;->sCtPlmn:[Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-interface {v1, p0, v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->setUiNotReadyEvent(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public dispose()V
    ...
    invoke-interface {v0, p0}, Lcom/android/internal/telephony/CommandsInterface;->unSetUiNotReadyEvent(Landroid/os/Handler;)V
...
.method public getImeifFromNv(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getImeifFromNv(Landroid/os/Message;)V
...
.method public getStoreMaxSize(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getStoreMaxSize(Landroid/os/Message;)V
...
.method public getUPlmn(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getUPlmn(Landroid/os/Message;)V
...
.method public isUSim()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->isUSim()Z
...
.method public isVideoWifiCallingEnabled()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->isVideoWifiCallingEnabled()Z
...
.method protected phoneObjectUpdater(I)V
    ...
    const-string v15, "phoneObjectUpdater: newVoiceRadioTech="
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/PhoneProxy;->logd(Ljava/lang/String;)V
    ...
    const-string v15, "carrier_config"
    ...
    invoke-virtual {v3, v14}, Landroid/telephony/CarrierConfigManager;->getConfigForSubId(I)Landroid/os/PersistableBundle;
    ...
    .line 251
    .local v13, "volteReplacementRat":I
    move-object/from16 v0, p0
    ...
    .line 255
    sget-object v1, Lcom/android/internal/telephony/PhoneProxy;->sCtPlmn:[Ljava/lang/String;
    ...
    .line 256
    .local v4, "ctPlmn":Ljava/lang/String;
    ...
    .end local v4    # "ctPlmn":Ljava/lang/String;
    .end local v5    # "i$":I
    .end local v7    # "len$":I
    :cond_2
    new-instance v14, Ljava/lang/StringBuilder;
    ...
    const-string v15, "phoneObjectUpdater: volteReplacementRat="
    ...
    .end local v13    # "volteReplacementRat":I
    :cond_3
    :goto_1
    move-object/from16 v0, p0

    iget v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mRilVersion:I
    ...
    const-string v15, "phoneObjectUpdater: LTE ON CDMA property is set. Use CDMA Phone newVoiceRadioTech="
    ...
    :cond_4
    const-string v14, "phoneObjectUpdater: didn\'t get volteReplacementRat from carrier config"

    move-object/from16 v0, p0

    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/PhoneProxy;->loge(Ljava/lang/String;)V
    ...
    const-string v15, "phoneObjectUpdater: LTE ON CDMA property is set. Switch to CDMALTEPhone newVoiceRadioTech="
    ...
    const-string v15, "phoneObjectUpdater: Unknown rat ignore,  newVoiceRadioTech=Unknown. mActivePhone="
    ...
    .line 292
    const-string v14, "Device is shutting down. No need to switch phone now."
    ...
    const-string v15, "phoneObjectUpdater: No change ignore, newVoiceRadioTech="
    ...
    const-string v15, " doesn\'t match either CDMA or GSM - error! No phone change"
    ...
    .line 324
    .end local v8    # "matchCdma":Z
    .end local v9    # "matchGsm":Z
    :cond_c
    const/4 v10, 0x0

    .line 325
    .local v10, "oldPowerState":Z
    move-object/from16 v0, p0

    iget-boolean v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mResetModemOnRadioTechnologyChange:Z
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mCommandsInterface:Lcom/android/internal/telephony/CommandsInterface;
    ...
    .line 328
    const-string v14, "phoneObjectUpdater: Setting Radio Power to Off"
    ...
    .line 336
    const-string v14, "phoneObjectUpdater: Resetting Radio"
    ...
    invoke-interface {v14, v10, v15}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V

    .line 341
    :cond_e
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/internal/telephony/PhoneProxy;->mIccSmsInterfaceManager:Lcom/android/internal/telephony/IccSmsInterfaceManager;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    check-cast v14, Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v15, v14}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->updatePhoneObject(Lcom/android/internal/telephony/PhoneBase;)V

    .line 342
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mIccPhoneBookInterfaceManagerProxy:Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v15}, Lcom/android/internal/telephony/Phone;->getIccPhoneBookInterfaceManager()Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;

    move-result-object v15

    invoke-virtual {v14, v15}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;->setmIccPhoneBookInterfaceManager(Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;)V

    .line 344
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneSubInfoProxy:Lcom/android/internal/telephony/PhoneSubInfoProxy;

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v15}, Lcom/android/internal/telephony/Phone;->getPhoneSubInfo()Lcom/android/internal/telephony/PhoneSubInfo;

    move-result-object v15

    invoke-virtual {v14, v15}, Lcom/android/internal/telephony/PhoneSubInfoProxy;->setmPhoneSubInfo(Lcom/android/internal/telephony/PhoneSubInfo;)V
    ...
    iput-object v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mCommandsInterface:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setVoiceRadioTech(I)V
    ...
    iget v14, v0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneId:I
    ...
    invoke-static {v6, v14, v15}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/telephony/dataconnection/DctController;->updatePhoneObject(Lcom/android/internal/telephony/PhoneProxy;)V
...
.method public registerForMiscInfo(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 1
    .param p1, "h"    # Landroid/os/Handler;
    .param p2, "what"    # I
    .param p3, "obj"    # Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerForMiscInfo(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public sendMiscInfo(ILjava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->sendMiscInfo(ILjava/lang/String;Landroid/os/Message;)V
...
.method public setUPlmn([BLandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->setUPlmn([BLandroid/os/Message;)V
...
.method public unregisterForMiscInfo(Landroid/os/Handler;)V
    .locals 1
    .param p1, "h"    # Landroid/os/Handler;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterForMiscInfo(Landroid/os/Handler;)V
