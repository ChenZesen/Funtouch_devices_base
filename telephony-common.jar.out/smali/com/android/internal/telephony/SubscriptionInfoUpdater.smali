...
.field private static final EVENT_SIM_ABSENT_DEALY:I = 0xc8
...
.field private static final EVENT_SIM_NOT_READY:I = 0x8
...
.field private mNotifyPinAgain:[Z
...
.method public constructor <init>(Landroid/content/Context;[Lcom/android/internal/telephony/Phone;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mNotifyPinAgain:[Z
    ...
    .line 148
    iget-object v2, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mNotifyPinAgain:[Z
...
.method static synthetic access$600(Lcom/android/internal/telephony/SubscriptionInfoUpdater;)[Z
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mNotifyPinAgain:[Z
...
.method private broadcastSimStateChanged(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/SubscriptionController;->isSubInfoReady()Z
    ...
    .line 899
    iget-object v1, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mNotifyPinAgain:[Z
...
.method private getImsi(I)Ljava/lang/String;
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/Phone;->getUiccCard()Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    .line 446
    .local v0, "app3GPP":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    const/4 v5, 0x2
    ...
    .line 447
    .local v1, "app3GPP2":Lcom/android/internal/telephony/uicc/UiccCardApplication;
    if-eqz v1, :cond_3
    ...
    const-string v6, "getImsi app3GPP2 imsi = "
    ...
    const-string v6, "getImsi app3GPP imsi = "
...
.method private getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;
    .locals 3
    .param p1, "slot"    # I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
...
.method private tryNotifyPinAgain()V
    .locals 3
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;
...
.method private updateSubName(I)V
    ...
    const-string v9, "updateSubName subId = "
    ...
    .line 478
    .local v4, "slotId":I
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->getImsi(I)Ljava/lang/String;
    ...
    const-string v9, "updateSubName, imsi = "
    ...
    .line 481
    sget-boolean v8, Lcom/android/internal/telephony/PhoneFactory;->sIsOversea:Z
    ...
    invoke-static {v0, v8}, Lcom/android/internal/telephony/TelephonyPhoneUtils;->checkOperatorForSimNameByImsi(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 487
    const-string v8, "Operator name is not (cm cu ct)!"
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/SubscriptionController;->getSubIdUsingPhoneId(I)I
    ...
    invoke-virtual {v8, v5, v9}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;

    move-result-object v7

    .line 493
    .local v7, "subInfo2":Landroid/telephony/SubscriptionInfo;
    if-eqz v7, :cond_3

    .line 494
    rsub-int/lit8 v8, v4, 0x1

    invoke-direct {p0, v8}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->getImsi(I)Ljava/lang/String;
    ...
    invoke-static {v1, v8}, Lcom/android/internal/telephony/TelephonyPhoneUtils;->checkOperatorForSimNameByImsi(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;

    move-result-object v3

    .line 496
    .local v3, "nameToSet2":Ljava/lang/String;
    invoke-virtual {v2, v3}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v8, v3, v5}, Landroid/telephony/SubscriptionManager;->setDisplayName(Ljava/lang/String;I)I

    .line 505
    .end local v1    # "imsi2":Ljava/lang/String;
    .end local v3    # "nameToSet2":Ljava/lang/String;
    :cond_3
    iget-object v8, p0, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->mSubscriptionManager:Landroid/telephony/SubscriptionManager;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v5, "vivo.factory.virtualsim"
    ...
    .line 324
    const-string v5, "EVENT_QUERY_ICCID_DONE sim1 is virtualSim!!!"
    ...
    const-string v6, "89860000000000000001"
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->handleSimError(I)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->handleSimNotReady(I)V
...
.method protected handleSimAbsent(I)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/SubscriptionController;->isSubInfoReady()Z
    ...
    const-string v3, "isAllCardAbsent:"
    ...
    .line 666
    :cond_3
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->hasMessages(I)Z
    ...
    .line 667
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->removeMessages(I)V

    .line 685
    .end local v0    # "i":I
    .end local v1    # "isAllCardAbsent":Z
    :cond_4
    :goto_1
    ...
    .restart local v1    # "isAllCardAbsent":Z
    :cond_5
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->hasMessages(I)Z
    ...
    invoke-virtual {p0, v4, v2, v3}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->sendEmptyMessageDelayed(IJ)Z
...
.method protected handleSimLoaded(I)V
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->updateSubName(I)V
    ...
    const-string v17, "sys.super_power_save"
    ...
    sget-boolean v17, Lcom/android/internal/telephony/PhoneFactory;->sIsOversea:Z
    ...
    invoke-static {v0, v14}, Lcom/android/internal/telephony/PhoneFactory;->calculatePreferredNetworkType(Landroid/content/Context;I)I
...
.method protected handleSimNotReady(I)V
    ...
    .prologue
    .line 702
    const-string v0, "handleSimNotReady."
...
.method protected declared-synchronized updateSubscriptionInfoByIccId()V
    ...
    .line 856
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->tryNotifyPinAgain()V
