...
.field protected static final EVENT_LOAD_QMI_PBM_RECORDS_DONE:I = 0x4
...
.field protected static final EVENT_UPDATE_QMI_PBM_RECORD_DONE:I = 0x5
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field private static final QMI_PBM_MAX_TRY_TIMES:I = 0x2
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field protected static final mGetSizeLock:Ljava/lang/Object;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mGetSizeLock:Ljava/lang/Object;
...
.method private getErrorCauseFromException(Lcom/android/internal/telephony/CommandException;)I
    ...
    .line 884
    :cond_0
    sget-object v1, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager$1;->$SwitchMap$com$android$internal$telephony$CommandException$Error:[I
...
.method private is3G()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->get3gTransferTo2gFlag()Z
...
.method protected checkThread()V
    ...
    .prologue
    .line 681
    const-string v0, "To check telephony phonebook deadlock patch valid!"
...
.method public getAdnCount()I
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->get3gTransferTo2gFlag()Z
    ...
    .line 814
    const-string v1, "getAdnCount , get3gTransferTo2gFlag is true!"
    ...
    .line 817
    :cond_1
    const-string v1, "getAdnCount , get3gTransferTo2gFlag is false!"
...
.method public getAdnLength()I
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->is3G()Z

    move-result v1

    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->getAdnLength(Z)I
...
.method public getAdnRecordsFromQmiPbm()Ljava/util/List;
    .locals 7
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
    ...
    const-string v5, "getAdnRecordsFromQmiPbm: i = "
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mBaseHandler:Lcom/android/internal/telephony/IccPhoneBookInterfaceManager$IccPbHandler;

    const/4 v6, 0x4

    invoke-virtual {v4, v6, v3}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager$IccPbHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v4, v2}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->requestLoadAllQmiPbmRecords(Landroid/os/Message;)V
    ...
    .line 989
    iget v4, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mErrorCause:I
    ...
    :cond_1
    :try_start_1
    const-string v4, "getAdnRecordsFromQmiPbm failed due to uninitialised adncache"
    ...
    const-string v4, "getAdnRecordsFromQmiPbm: InterruptedException"
    ...
    .end local v3    # "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    :cond_4
    const-string v4, "getAdnRecordsFromQmiPbm failed, try getAdnRecordsInEf"
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getAdnRecordsInEf(I)Ljava/util/List;
...
.method public getAnrLength()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->getAnrLength(Z)I
...
.method public getEmailLength()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->getEmailLength(Z)I
...
.method public getQmiPbmCapabilities()[I
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->getQmiPbmCapabilities()[I
    ...
    .line 958
    :cond_0
    const-string v0, "getQmiPbmCapabilities failed due to uninitialised adncache"
...
.method public isPhoneBookRecordsReady(I)Z
    ...
    const-string v2, "isPhoneBookRecordsReady: efid="
    ...
    invoke-virtual {v1, p1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->isPhoneBookRecordsReady(I)Z
    ...
    .line 1052
    :cond_0
    const-string v1, "Failure while trying to load from SIM due to uninitialised adncache"
...
.method public declared-synchronized updateAdnRecordsInEfBySearchWithError(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v1, v7}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager$IccPbHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->updateAdnBySearchWithError(ILcom/android/internal/telephony/uicc/AdnRecord;Lcom/android/internal/telephony/uicc/AdnRecord;Ljava/lang/String;Landroid/os/Message;)I
    ...
    const-string v1, "updateAdnRecordsWithContentValuesInEfBySearch success index is "
...
.method public updateAdnRecordsWithContentValuesInEfBySearch(ILandroid/content/ContentValues;Ljava/lang/String;)Z
    ...
    .line 466
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->updateAdnRecordsWithContentValuesInEfBySearchWithError(ILandroid/content/ContentValues;Ljava/lang/String;)I
...
.method public declared-synchronized updateAdnRecordsWithContentValuesInEfBySearchWithError(ILandroid/content/ContentValues;Ljava/lang/String;)I
    .locals 25
    .param p1, "efid"    # I
    .param p2, "values"    # Landroid/content/ContentValues;
    .param p3, "pin2"    # Ljava/lang/String;
    ...
    .line 489
    .local v21, "oldPhoneNumber":Ljava/lang/String;
    ...
    .line 490
    .local v15, "newPhoneNumber":Ljava/lang/String;
    ...
    .line 491
    .local v19, "oldEmail":Ljava/lang/String;
    ...
    .line 493
    .local v17, "oldAnr":Ljava/lang/String;
    ...
    .line 495
    .local v20, "oldEmailArray":[Ljava/lang/String;
    :goto_0
    ...
    .line 496
    .local v14, "newEmailArray":[Ljava/lang/String;
    :goto_1
    ...
    .line 497
    .local v18, "oldAnrArray":[Ljava/lang/String;
    :goto_2
    ...
    .line 498
    .local v12, "newAnrArray":[Ljava/lang/String;
    :goto_3
    ...
    .line 507
    .local v23, "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    move-object/from16 v0, p0
    ...
    invoke-direct {v7, v0, v15, v14, v12}, Lcom/android/internal/telephony/uicc/AdnRecord;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->updateAdnBySearchWithError(ILcom/android/internal/telephony/uicc/AdnRecord;Lcom/android/internal/telephony/uicc/AdnRecord;Ljava/lang/String;Landroid/os/Message;)I
    ...
    iget v4, v0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mErrorCause:I
    ...
    const-string v5, "updateAdnRecordsWithContentValuesInEfBySearch success index is "
    ...
    .end local v12    # "newAnrArray":[Ljava/lang/String;
    .end local v14    # "newEmailArray":[Ljava/lang/String;
    .end local v18    # "oldAnrArray":[Ljava/lang/String;
    .end local v20    # "oldEmailArray":[Ljava/lang/String;
    .end local v23    # "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 495
    .restart local v20    # "oldEmailArray":[Ljava/lang/String;
    :cond_2
    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getStringArray(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 496
    .restart local v14    # "newEmailArray":[Ljava/lang/String;
    :cond_3
    move-object/from16 v0, p0
    ...
    .line 497
    .restart local v18    # "oldAnrArray":[Ljava/lang/String;
    :cond_4
    move-object/from16 v0, p0

    invoke-direct {v0, v11}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getStringArray(Ljava/lang/String;)[Ljava/lang/String;
    :try_end_4
    ...
    .restart local v12    # "newAnrArray":[Ljava/lang/String;
    .restart local v23    # "status":Ljava/util/concurrent/atomic/AtomicBoolean;
    :cond_5
    :try_start_5
    ...
    iget v10, v0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mErrorCause:I
    :try_end_6
...
.method public declared-synchronized updateQmiPbmRecord(ILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)I
    .locals 6
    .param p1, "index"    # I
    ...
    const-string v4, "updateQmiPbmRecord: index = "
    ...
    invoke-direct {v0, p2, p3, p4, p5}, Lcom/android/internal/telephony/uicc/AdnRecord;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V

    .line 1027
    .local v0, "newRecord":Lcom/android/internal/telephony/uicc/AdnRecord;
    iget-object v3, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mAdnCache:Lcom/android/internal/telephony/uicc/AdnRecordCache;

    invoke-virtual {v3, p1, v0, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->updateQmiPbmRecord(ILcom/android/internal/telephony/uicc/AdnRecord;Landroid/os/Message;)V
    ...
    .line 1033
    .end local v0    # "newRecord":Lcom/android/internal/telephony/uicc/AdnRecord;
    :goto_0
    monitor-exit v4
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    :cond_1
    :try_start_4
    const-string v3, "updateQmiPbmRecord failed due to uninitialised adncache"
...
.method protected waitForResultForGetSize(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    .locals 2
    .param p1, "status"    # Ljava/util/concurrent/atomic/AtomicBoolean;
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_METHOD:Landroid/annotation/VivoHook$VivoHookType;
