...
.field private static final EVENT_EXECUTE_ALL_REQUESTS_PHONE0:I = 0x7d0
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field

.field private static final EVENT_EXECUTE_ALL_REQUESTS_PHONE1:I = 0x7d1
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.field private static mNetworkFactory:[Landroid/net/NetworkFactory;

.field private static mNetworkFactoryMessenger:[Landroid/os/Messenger;

.field private static mOldDataPhoneId:I
    .annotation runtime Landroid/annotation/VivoHook;
        hookType = .enum Landroid/annotation/VivoHook$VivoHookType;->NEW_FIELD:Landroid/annotation/VivoHook$VivoHookType;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/dataconnection/DctController;->mOldDataPhoneId:I
...
.method protected constructor <init>([Lcom/android/internal/telephony/PhoneProxy;)V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mLock:Ljava/lang/Object;
    ...
    .line 339
    sget-object v4, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactoryMessenger:[Landroid/os/Messenger;
    ...
    sput-object v4, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactoryMessenger:[Landroid/os/Messenger;

    .line 341
    :cond_3
    sget-object v4, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
    ...
    sput-object v4, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
...
.method static synthetic access$100(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/net/NetworkRequest;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$200(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/net/NetworkRequest;ILandroid/util/LocalLog;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;
    .param p1, "x1"    # Landroid/net/NetworkRequest;
    .param p2, "x2"    # I
...
.method static synthetic access$300(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/net/NetworkRequest;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;
    .param p1, "x1"    # Landroid/net/NetworkRequest;
...
.method private requestNetwork(Landroid/net/NetworkRequest;ILandroid/util/LocalLog;)I
    ...
    .line 456
    .local v0, "requestInfo":Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;
    iget-object v2, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mLock:Ljava/lang/Object;
...
.method private resetPdnRequests(I)V
    .locals 11
    .param p1, "phoneId"    # I
    ...
    .line 638
    :cond_1
    iget v8, v6, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->executedPhoneId:I
    ...
    .line 640
    .local v0, "apn":Ljava/lang/String;
    iget v3, v6, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->executedPhoneId:I

    .line 641
    .local v3, "executedPhoneId":I
    ...
    .line 645
    iput v10, v6, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->executedPhoneId:I
    ...
    .end local v3    # "executedPhoneId":I
...
.method private updatePhoneBaseForIndex(ILcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string v2, "updatePhoneBaseForIndex for phone index="
    ...
    .line 166
    .local v12, "isNetworkFilterReset":Z
    invoke-virtual/range {p2 .. p2}, Lcom/android/internal/telephony/PhoneBase;->getServiceStateTracker()Lcom/android/internal/telephony/ServiceStateTracker;

    move-result-object v1

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mRspHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/android/internal/telephony/ServiceStateTracker;->registerForDataConnectionAttached(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/android/internal/telephony/ServiceStateTracker;->registerForDataConnectionDetached(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 170
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mRspHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/telephony/PhoneBase;->registerForEmergencyCallToggle(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 173
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mPhones:[Lcom/android/internal/telephony/PhoneProxy;
    ...
    iget-object v1, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFilter:[Landroid/net/NetworkCapabilities;
    ...
    .line 222
    :cond_0
    sget-object v1, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
    ...
    .line 223
    sget-object v17, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;

    new-instance v1, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;
    ...
    const-string v5, "TelephonyNetworkFactory"
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;-><init>(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/os/Looper;Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/Phone;Landroid/net/NetworkCapabilities;)V

    aput-object v1, v17, p1
    ...
    .line 227
    sget-object v1, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactoryMessenger:[Landroid/os/Messenger;

    new-instance v2, Landroid/os/Messenger;

    sget-object v3, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
    ...
    invoke-virtual {v9, v1, v2}, Landroid/net/ConnectivityManager;->registerNetworkFactory(Landroid/os/Messenger;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/dataconnection/DctController;->hasMessages(I)Z
    ...
    .line 269
    const-string v1, "removeMessages EVENT_EXECUTE_ALL_REQUESTS_PHONE0"
    ...
    const-string v2, " mNetworkRequests clear"
    ...
    .line 230
    const-class v8, Landroid/net/NetworkFactory;

    .line 232
    .local v8, "cls":Ljava/lang/Class;, "Ljava/lang/Class<Landroid/net/NetworkFactory;>;"
    :try_start_0
    const-string v1, "mNetworkRequests"
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mLock:Ljava/lang/Object;
    ...
    .line 246
    .local v14, "needDeleteInfo":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;>;"
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mRequestInfos:Ljava/util/HashMap;
    ...
    .line 248
    .local v13, "iterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    :cond_3
    :goto_3
    ...
    check-cast v15, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;

    .line 251
    .local v15, "requestInfo":Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;
    iget-object v1, v15, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->request:Landroid/net/NetworkRequest;
    ...
    .line 252
    .local v16, "specifier":Ljava/lang/String;
    if-eqz v16, :cond_3
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/dataconnection/DctController;->getRequestPhoneId(Landroid/net/NetworkRequest;)I
    ...
    const-string v3, "remove requestInfo.request.requestId = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v3, v15, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->request:Landroid/net/NetworkRequest;
    ...
    .line 262
    .end local v13    # "iterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    .end local v14    # "needDeleteInfo":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;>;"
    .end local v15    # "requestInfo":Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;
    .end local v16    # "specifier":Ljava/lang/String;
    :catchall_0
    move-exception v1
    ...
    const-string v2, " mNetworkRequests clear exception : NoSuchFieldException"
    ...
    const-string v2, " mNetworkRequests clear exception : IllegalAccessException"
    ...
    const-string v2, " mNetworkRequests clear exception : IllegalArgumentException"
    ...
    .restart local v14    # "needDeleteInfo":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;>;"
    :cond_4
    :try_start_2
    monitor-exit v2
    :try_end_2
    ...
    invoke-virtual {v9, v1}, Landroid/net/ConnectivityManager;->unregisterNetworkFactory(Landroid/os/Messenger;)V
    ...
    # invokes: Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;->updatePhone(Lcom/android/internal/telephony/PhoneBase;)V
    invoke-static {v1, v0}, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;->access$000(Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;Lcom/android/internal/telephony/PhoneBase;)V

    goto/16 :goto_0

    .line 271
    .end local v8    # "cls":Ljava/lang/Class;, "Ljava/lang/Class<Landroid/net/NetworkFactory;>;"
    .end local v14    # "needDeleteInfo":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;>;"
    :cond_5
    const/4 v1, 0x1
    ...
    .line 272
    const-string v1, "removeMessages EVENT_EXECUTE_ALL_REQUESTS_PHONE1"
...
.method public dispose()V
    ...
    .prologue
    .line 389
    const-string v0, "DctController.dispose"

    invoke-static {v0}, Lcom/android/internal/telephony/dataconnection/DctController;->logd(Ljava/lang/String;)V

    .line 400
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mSubMgr:Landroid/telephony/SubscriptionManager;

    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mOnSubscriptionsChangedListener:Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mObserver:Landroid/database/ContentObserver;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1099
    sget-object v0, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
...
.method public hasMmsRequest()Z
    ...
    .prologue
    .line 1110
    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mLock:Ljava/lang/Object;
    ...
    const-string v5, "hasMmsRequest apn = "
...
.method protected onSettingsChanged()V
    ...
    sget-boolean v4, Lcom/android/internal/telephony/PhoneFactory;->sIsUNICOMEntry:Z
    ...
    sget v4, Lcom/android/internal/telephony/dataconnection/DctController;->mOldDataPhoneId:I

    if-eq v1, v4, :cond_0

    .line 665
    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mNeedsDdsSwitch:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v4, v5}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    .line 666
    sput v1, Lcom/android/internal/telephony/dataconnection/DctController;->mOldDataPhoneId:I

    .line 673
    .end local v1    # "dataPhoneId":I
    :cond_0
    :goto_0
    const/4 v0, -0x1
    ...
    const-string v5, "onSettingsChange, activePhoneId = "
    ...
    .line 683
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/dataconnection/DctController;->resetPdnRequests(I)V
    ...
    .line 674
    .restart local v0    # "activePhoneId":I
...
.method protected onSubInfoReady()V
    ...
    .line 762
    .local v1, "dcTracker":Lcom/android/internal/telephony/dataconnection/DcTrackerBase;
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/dataconnection/DctController;->resetPdnRequests(I)V
    ...
    .line 765
    sget-object v6, Lcom/android/internal/telephony/dataconnection/DctController;->mNetworkFactory:[Landroid/net/NetworkFactory;
