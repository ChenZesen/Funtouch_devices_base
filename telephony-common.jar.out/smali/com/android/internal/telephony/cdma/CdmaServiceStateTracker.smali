...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    invoke-static {v0, v2, v4, v5, v1}, Landroid/util/TimeUtils;->getTimeZone(IZJLjava/lang/String;)Ljava/util/TimeZone;
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mZoneDst:Z
    ...
    const-string v3, " mGotCountryCode="
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mGotCountryCode:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, " mNeedFixZone="
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNeedFixZone:Z
    ...
    invoke-direct {v0, v1, v2, v4, v5}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->getNitzTimeZone(IZJ)Ljava/util/TimeZone;
    ...
    invoke-direct {v0, v2, v3}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->setAndBroadcastNetworkSetTime(J)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .end local v10    # "ar":Landroid/os/AsyncResult;
    :pswitch_14
    const-string v4, "EVENT_NOTIFY_SIGNAL_STRENGTH_CALL_END"
    ...
    invoke-virtual {v4, v0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyServiceStateChanged(Landroid/telephony/ServiceState;)V
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v9, v10}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isRoamingBetweenOperators(ZLandroid/telephony/ServiceState;)Z
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {v4, v15}, Landroid/telephony/ServiceState;->setDataRegState(I)V
    ...
    invoke-virtual {v4, v14}, Landroid/telephony/ServiceState;->setRilDataRadioTechnology(I)V
    ...
    invoke-virtual {v0, v12, v4}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isRoamingBetweenOperators(ZLandroid/telephony/ServiceState;)Z
    ...
    invoke-virtual {v4, v12}, Landroid/telephony/ServiceState;->setVoiceRoaming(Z)V
    ...
    invoke-virtual {v4, v13}, Landroid/telephony/ServiceState;->setCssIndicator(I)V
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/NitzTimeUpdatePolicy;->getInstance(Landroid/content/Context;)Lcom/android/internal/telephony/NitzTimeUpdatePolicy;
    ...
    invoke-virtual {v4, v0, v1, v2, v3}, Lcom/android/internal/telephony/NitzTimeUpdatePolicy;->checkCollectErrorTime(ILjava/lang/String;Landroid/telephony/CellLocation;Z)V
    ...
    .line 817
    .restart local v18    # "ex":Ljava/lang/NumberFormatException;
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    const-string v32, "ro.cdma.home.operator.numeric"
    ...
    const-string v32, "RIL_REQUEST_OPERATOR.response[2], the numeric,  is bad. Using SystemProperties \'ro.cdma.home.operator.numeric\'= "
    ...
    invoke-virtual {v4, v11, v11, v0}, Landroid/telephony/ServiceState;->setOperatorName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 900
    .local v29, "strOperatorLong":Ljava/lang/String;
    const/4 v4, 0x0

    aget-object v29, v21, v4
    ...
    .line 902
    .local v30, "strOperatorShort":Ljava/lang/String;
    const/16 v22, 0x0

    .line 904
    .local v22, "override":Z
    const/4 v4, 0x2
    ...
    invoke-virtual {v4, v0}, Lcom/android/internal/telephony/CustomPlmnOperatorOverride;->getOperator(Ljava/lang/String;)Lcom/android/internal/telephony/CustomPlmnOperatorOverride$OperatorName;

    move-result-object v10

    .line 924
    .local v10, "alpName":Lcom/android/internal/telephony/CustomPlmnOperatorOverride$OperatorName;
    if-eqz v10, :cond_1b

    .line 925
    iget-object v0, v10, Lcom/android/internal/telephony/CustomPlmnOperatorOverride$OperatorName;->longName:Ljava/lang/String;

    move-object/from16 v29, v0

    .line 926
    iget-object v0, v10, Lcom/android/internal/telephony/CustomPlmnOperatorOverride$OperatorName;->shortName:Ljava/lang/String;
    ...
    .line 932
    .end local v10    # "alpName":Lcom/android/internal/telephony/CustomPlmnOperatorOverride$OperatorName;
    :cond_1b
    :goto_8
    new-instance v4, Ljava/lang/StringBuilder;
    ...
    .line 914
    .local v19, "longnameNospace":Ljava/lang/String;
    const/4 v4, 0x2
    ...
    .line 915
    .local v20, "numberic":Ljava/lang/String;
    ...
    .line 928
    .end local v19    # "longnameNospace":Ljava/lang/String;
    .end local v20    # "numberic":Ljava/lang/String;
    :catch_2
    move-exception v17

    .line 929
    .local v17, "e":Ljava/lang/Exception;
    const-string v4, "CustomPlmnOperatorOverride is not init"
    ...
    .end local v22    # "override":Z
    .end local v29    # "strOperatorLong":Ljava/lang/String;
    .end local v30    # "strOperatorShort":Ljava/lang/String;
    :cond_1f
...
.method protected isRoamingBetweenOperators(ZLandroid/telephony/ServiceState;)Z
    ...
    iget-object v12, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mPhoneBase:Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v12}, Lcom/android/internal/telephony/PhoneBase;->getPhoneId()I

    move-result v12

    invoke-virtual {v9, v12}, Landroid/telephony/TelephonyManager;->getSimOperatorNameForPhone(I)Ljava/lang/String;
    ...
    invoke-static {v8, v9, v12}, Landroid/telephony/TelephonyManager;->getTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1767
    invoke-static {v5, v6}, Lcom/android/internal/telephony/TelephonyPhoneUtils;->isSameOperator(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .end local v3    # "onsl":Ljava/lang/String;
    .end local v4    # "onss":Ljava/lang/String;
    ...
    invoke-virtual {p0, v9, v12}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    goto :goto_0

    .restart local v3    # "onsl":Ljava/lang/String;
    .restart local v4    # "onss":Ljava/lang/String;
    :cond_2
    move v0, v11
...
.method protected pollStateDone()V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsSSInit:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsSSInit:Z
    ...
    const-string v30, "pollStateDone:isOtherPhoneInCall = "
    ...
    .line 1447
    const-string v29, "gsm.vivo.countrycode"
    ...
    .line 1448
    .local v23, "preCode":Ljava/lang/String;
    ...
    const-string v30, "device_current_country"
    ...
    .line 1461
    .end local v23    # "preCode":Ljava/lang/String;
    :cond_24
    :goto_11
    move-object/from16 v0, p0
...
.method protected updateSpnDisplay()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->updatePlmnShow(Ljava/lang/String;)Ljava/lang/String;
...
.method protected updateSpnDisplay(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->updatePlmnShow(Ljava/lang/String;)Ljava/lang/String;
    ...
    .local v2, "showPlmn":Z
    :goto_0
    const-string v5, "updateSpnDisplay: changed sending intent showPlmn=\'%b\' plmn=\'%s\' phoneId = %d"
