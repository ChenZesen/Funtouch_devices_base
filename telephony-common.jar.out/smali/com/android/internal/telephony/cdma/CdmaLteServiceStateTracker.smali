...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .end local v1    # "dds":I
    :sswitch_4
    const-string v3, "EVENT_NOTIFY_SIGNAL_STRENGTH_CALL_END"

    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->log(Ljava/lang/String;)V

    .line 152
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->notifySignalStrength()Z

    .line 153
    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mPhone:Lcom/android/internal/telephony/cdma/CDMAPhone;

    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mSS:Landroid/telephony/ServiceState;

    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyServiceStateChanged(Landroid/telephony/ServiceState;)V
...
.method protected onSignalStrengthResult(Landroid/os/AsyncResult;Z)Z
    ...
    .line 679
    .local v2, "tempSignalStrength":Landroid/telephony/SignalStrength;
    ...
    .end local v2    # "tempSignalStrength":Landroid/telephony/SignalStrength;
    check-cast v2, Landroid/telephony/SignalStrength;

    .line 683
    .restart local v2    # "tempSignalStrength":Landroid/telephony/SignalStrength;
    :cond_0
    if-eqz v2, :cond_1
    ...
    const-string v4, "onSignalStrengthResult: tempSignalStrength.getLteRsrp = "
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->isRatLte(I)Z
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfo:Landroid/telephony/CellInfo;
    ...
    .line 695
    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfoLte:Landroid/telephony/CellInfoLte;
    ...
    invoke-virtual {v3, v6, v7}, Landroid/telephony/CellInfoLte;->setTimeStamp(J)V
    ...
    invoke-virtual {v3, v5}, Landroid/telephony/CellInfoLte;->setTimeStampType(I)V
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mSignalStrength:Landroid/telephony/SignalStrength;

    const v6, 0x7fffffff

    invoke-virtual {v3, v5, v6}, Landroid/telephony/CellSignalStrengthLte;->initialize(Landroid/telephony/SignalStrength;I)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyCellInfo(Ljava/util/List;)V
...
.method protected pollStateDone()V
    ...
    const-string v44, ", initialize the SignalStrength bss"
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mGsmBssWorking:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mTdBssWorking:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLteBssWorking:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCdmaBssWorking:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mEvdoBssWorking:Z
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mIsSSInit:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mIsSSInit:Z
    ...
    const-string v44, "pollStateDone:isOtherPhoneInCall = "
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isOtherPhoneInCall:Z
    ...
    .line 566
    :goto_19
    const-string v43, "persist.radio.vivo.mcc"
    ...
    .line 567
    .local v33, "preMcc":Ljava/lang/String;
    ...
    .line 569
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->notifyUserCountryChange()V
    ...
    .line 559
    .end local v33    # "preMcc":Ljava/lang/String;
    :catch_0
    move-exception v10
