.class public final Lcom/vivo/services/motion/gesture/gesture/GestureUtils;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->NONUNIFORM_SCALE:F
...
.method public static computeOrientedBoundingBox(Ljava/util/ArrayList;)Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;)",
            "Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;"
        }
    .end annotation

    .prologue
    .line 471
    .local p0, "originalPoints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vivo/services/motion/gesture/gesture/GesturePoint;>;"
    ...
    check-cast v4, Lcom/vivo/services/motion/gesture/gesture/GesturePoint;

    .line 475
    .local v4, "point":Lcom/vivo/services/motion/gesture/gesture/GesturePoint;
    mul-int/lit8 v2, v1, 0x2

    .line 476
    .local v2, "index":I
    iget v6, v4, Lcom/vivo/services/motion/gesture/gesture/GesturePoint;->x:F
    ...
    iget v7, v4, Lcom/vivo/services/motion/gesture/gesture/GesturePoint;->y:F
    ...
    .end local v4    # "point":Lcom/vivo/services/motion/gesture/gesture/GesturePoint;
    :cond_0
    invoke-static {v5}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeCentroid([F)[F

    move-result-object v3

    .line 480
    .local v3, "meanVector":[F
    invoke-static {v5, v3}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeOrientedBoundingBox([F[F)Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
...
.method public static computeOrientedBoundingBox([F)Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
    .locals 5
    ...
    .line 495
    :cond_0
    invoke-static {v2}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeCentroid([F)[F

    move-result-object v1

    .line 496
    .local v1, "meanVector":[F
    invoke-static {v2, v1}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeOrientedBoundingBox([F[F)Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
...
.method private static computeOrientedBoundingBox([F[F)Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
    .locals 15
    .param p0, "points"    # [F
    .param p1, "centroid"    # [F
    ...
    invoke-static {p0, v0, v1}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->translate([FFF)[F

    .line 502
    invoke-static {p0}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeCoVariance([F)[[F

    move-result-object v7

    .line 503
    .local v7, "array":[[F
    invoke-static {v7}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeOrientation([[F)[F
    ...
    invoke-static {p0, v0}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->rotate([FF)[F
    ...
    :cond_5
    new-instance v0, Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/vivo/services/motion/gesture/gesture/OrientedBoundingBox;-><init>(FFFFF)V
...
.method static computeStraightness([F)F
    ...
    .prologue
    .line 388
    invoke-static {p0}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->computeTotalLength([F)F
...
.method public static spatialSampling(Lcom/vivo/services/motion/gesture/gesture/Gesture;I)[F
    .locals 1
    .param p0, "gesture"    # Lcom/vivo/services/motion/gesture/gesture/Gesture;
    ...
    invoke-static {p0, p1, v0}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->spatialSampling(Lcom/vivo/services/motion/gesture/gesture/Gesture;IZ)[F
...
.method public static spatialSampling(Lcom/vivo/services/motion/gesture/gesture/Gesture;IZ)[F
    .locals 36
    .param p0, "gesture"    # Lcom/vivo/services/motion/gesture/gesture/Gesture;
    .param p1, "bitmapSize"    # I
    ...
    .line 96
    invoke-virtual/range {p0 .. p0}, Lcom/vivo/services/motion/gesture/gesture/Gesture;->getBoundingBox()Landroid/graphics/RectF;
    ...
    .line 134
    .local v12, "postDy":F
    invoke-virtual/range {p0 .. p0}, Lcom/vivo/services/motion/gesture/gesture/Gesture;->getStrokes()Ljava/util/ArrayList;

    move-result-object v27

    .line 135
    .local v27, "strokes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vivo/services/motion/gesture/gesture/GestureStroke;>;"
    ...
    check-cast v25, Lcom/vivo/services/motion/gesture/gesture/GestureStroke;

    .line 141
    .local v25, "stroke":Lcom/vivo/services/motion/gesture/gesture/GestureStroke;
    move-object/from16 v0, v25

    iget-object v0, v0, Lcom/vivo/services/motion/gesture/gesture/GestureStroke;->points:[F
    ...
    .end local v25    # "stroke":Lcom/vivo/services/motion/gesture/gesture/GestureStroke;
    .end local v26    # "strokepoints":[F
    .end local v27    # "strokes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vivo/services/motion/gesture/gesture/GestureStroke;>;"
    :cond_1
    move/from16 v18, v29
    ...
    .line 118
    sget v33, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->NONUNIFORM_SCALE:F
    ...
    .restart local v25    # "stroke":Lcom/vivo/services/motion/gesture/gesture/GestureStroke;
    .restart local v26    # "strokepoints":[F
    .restart local v27    # "strokes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vivo/services/motion/gesture/gesture/GestureStroke;>;"
    :cond_7
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/vivo/services/motion/gesture/gesture/GestureUtils;->plot(FF[FI)V
...
.method public static temporalSampling(Lcom/vivo/services/motion/gesture/gesture/GestureStroke;I)[F
    .locals 22
    .param p0, "stroke"    # Lcom/vivo/services/motion/gesture/gesture/GestureStroke;
    ...
    iget v0, v0, Lcom/vivo/services/motion/gesture/gesture/GestureStroke;->length:F
