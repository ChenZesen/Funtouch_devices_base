...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt BluetoothMidiService HTMLViewer KeyChain PicoTts PrintSpooler Stk UserDictionaryProvider BackupRestoreConfirmation BluetoothSettings DefaultContainerService ExternalStorageProvider FusedLocation InputDevices ProxyHandler SharedStorageBackup Shell
...
#-----------------------------------------------------------------------------
vendor_modify_jars := com.qti.dpmframework framework oem-services qti-telephony-common services telephony-common vivo-framework wifi-service
...
#----------------------------------------------------------------
# ro.funtouch.romer的属性值将包含在OTA包中
# 这个值默认为：Unofficial
