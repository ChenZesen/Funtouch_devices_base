...
.field private static final VIVO_ACCESS_POINT_CONTACT_KEY:Ljava/lang/String; = "VIVO_ACCESS_POINT_CONTACT"

.field private static final VIVO_CONFIG_INIT_TIME_KEY:Ljava/lang/String; = "VIVO_CONFIG_INIT_TIME"

.field private static final VIVO_CONNECTED_COUNT_KEY:Ljava/lang/String; = "VIVO_CONNECTED_COUNT"

.field private static final VIVO_IS_IN_RANGE_KEY:Ljava/lang/String; = "VIVO_IS_IN_RANGE"

.field private static final VIVO_IS_LAST_ENABLE_KEY:Ljava/lang/String; = "VIVO_IS_LAST_ENABLE"

.field private static final VIVO_LAST_AUTO_ENABLED_TIME_KEY:Ljava/lang/String; = "VIVO_LAST_AUTO_ENABLED_TIME"

.field private static final VIVO_LAST_CONNECTED_TIME_KEY:Ljava/lang/String; = "VIVO_LAST_CONNECTED_TIME"

.field private static final VIVO_LATITUDE_KEY:Ljava/lang/String; = "VIVO_LATITUDE"

.field private static final VIVO_LONGITUDE_KEY:Ljava/lang/String; = "VIVO_LONGITUDE"

.field private static final VIVO_NEED_AUTO_JOIN_SCAN_KEY:Ljava/lang/String; = "VIVO_NEED_AUTO_JOIN_SCAN"

.field private static final VIVO_NO_INTERNET_ACCESS_TIME_KEY:Ljava/lang/String; = "VIVO_NO_INTERNET_ACCESS_TIME"

.field private static final VIVO_NO_INTERNET_STATE_KEY:Ljava/lang/String; = "VIVO_NO_INTERNET_STATE"
...
.field public static isFull:Z = false
...
.field public enableAutoJoinWhenAssociated:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public final enableChipWakeUpWhenAssociated:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public enableFullBandScanWhenAssociated:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.field private lastListAttempt:J
...
.field public mtempConfiguredNetworks:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public shouldRemoveDeadAp:Z
...
.field public wifiDynamicBlacklistMinTimeMilli:I
...
.method static constructor <clinit>()V
    ...
    .line 549
    sput-boolean v3, Lcom/android/server/wifi/WifiConfigStore;->isFull:Z
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WifiNative;)V
    ...
    .line 359
    iput v4, p0, Lcom/android/server/wifi/WifiConfigStore;->maxTxPacketForFullScans:I
    ...
    iput v3, p0, Lcom/android/server/wifi/WifiConfigStore;->wifiDynamicBlacklistMinTimeMilli:I
    ...
    .line 390
    iput v4, p0, Lcom/android/server/wifi/WifiConfigStore;->associatedHysteresisLow:I
    ...
    iput-wide v4, p0, Lcom/android/server/wifi/WifiConfigStore;->lastListAttempt:J
    ...
    iput-object v3, p0, Lcom/android/server/wifi/WifiConfigStore;->mtempConfiguredNetworks:Ljava/util/List;

    .line 552
    iput-boolean v2, p0, Lcom/android/server/wifi/WifiConfigStore;->shouldRemoveDeadAp:Z
    ...
    invoke-static {v3}, Landroid/net/wifi/WlanCmccFwExt;->createInstance(Landroid/content/Context;)Landroid/net/wifi/IWifiFwkExt;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/wifi/WifiConfigStore;->mWifiFwkExt:Landroid/net/wifi/IWifiFwkExt;
    ...
    .line 696
    invoke-virtual {p0}, Lcom/android/server/wifi/WifiConfigStore;->setAutoJoinEnabled()V
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    const-string v6, "===CTRL-EVENT-BUFFER-FULL== eap-psk put lastConnectedtime "
    ...
    const-string v6, "lastConnectedtime"

    const-string v8, "\"4446554997387\""
...
.method private readNetworkHistory()V
    ...
    .line 2855
    .local v16, "e":Ljava/lang/StringIndexOutOfBoundsException;
    ...
    const-string v29, "readNetworkHistory: failed to read, revert to default, "
    ...
    .line 2575
    .end local v16    # "e":Ljava/lang/StringIndexOutOfBoundsException;
    .restart local v4    # "bssid":Ljava/lang/String;
    .restart local v5    # "caps":Ljava/lang/String;
    .restart local v6    # "rssi":I
    .restart local v7    # "freq":I
    ...
    const-string v30, "Upgrading network "
    ...
    :sswitch_26
    const-string v9, "VIVO_CONNECTED_COUNT"
    ...
    :sswitch_27
    const-string v9, "VIVO_CONFIG_INIT_TIME"
    ...
    :sswitch_28
    const-string v9, "VIVO_LAST_CONNECTED_TIME"
    ...
    :sswitch_29
    const-string v9, "VIVO_LAST_AUTO_ENABLED_TIME"
    ...
    :sswitch_2a
    const-string v9, "VIVO_NO_INTERNET_ACCESS_TIME"
    ...
    :sswitch_2c
    const-string v9, "VIVO_LONGITUDE"
    ...
    :sswitch_2d
    const-string v9, "VIVO_IS_IN_RANGE"
    ...
    :sswitch_2e
    const-string v9, "VIVO_IS_LAST_ENABLE"
    ...
    :sswitch_2f
    const-string v9, "VIVO_NO_INTERNET_STATE"
    ...
    :sswitch_30
    const-string v9, "VIVO_NEED_AUTO_JOIN_SCAN"
    ...
    :sswitch_31
    const-string v9, "VIVO_ACCESS_POINT_CONTACT"
    ...
    const-string v30, "WifiConfigStore: connectChoice:  Couldnt match pattern : "
    ...
    .line 2793
    :pswitch_26
    iget-object v8, v14, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-static/range {v24 .. v24}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I

    move-result v9

    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoConnectedCount(I)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoConfigInitTime(I)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoLastConnectedTime(I)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoLastAutoEnabledTime(I)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoNoInternetAccessTime(I)V
    ...
    invoke-virtual {v8, v0, v1}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoLatitude(D)V
    ...
    invoke-virtual {v8, v0, v1}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoLongitude(D)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoIsInRange(Z)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoIsLastEnableAP(Z)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoNoInternetState(I)V
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoNeedAutoJoinScan(Z)V
    ...
    .line 2827
    .local v26, "vivoConfigKey":Ljava/lang/String;
    const/16 v25, 0x0

    .line 2828
    .local v25, "vivoChoice":I
    sget-object v8, Lcom/android/server/wifi/WifiConfigStore;->mConnectChoice:Ljava/util/regex/Pattern;
    ...
    .line 2829
    .local v27, "vivoMatch":Ljava/util/regex/Matcher;
    ...
    const-string v30, "WifiConfigStore: vivoAccessPointContact:  Couldnt match pattern : "
    ...
    invoke-virtual {v8}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    invoke-virtual {v8, v9}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoAccessPointContact(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v8, v0, v1}, Landroid/net/wifi/VivoWifiConfiguration;->addVivoAccessPointContact(Ljava/lang/String;I)V
    :try_end_b
    ...
    .end local v16    # "e":Ljava/lang/NumberFormatException;
    .end local v21    # "slash":C
    .end local v25    # "vivoChoice":I
    .end local v26    # "vivoConfigKey":Ljava/lang/String;
    .end local v27    # "vivoMatch":Ljava/util/regex/Matcher;
    :catch_4
    move-exception v28

    .local v28, "x2":Ljava/lang/Throwable;
    :try_start_c
    move-object/from16 v0, v29
    ...
    :try_end_c
    .catch Ljava/lang/StringIndexOutOfBoundsException; {:try_start_c .. :try_end_c} :catch_1
    ...
    .end local v23    # "status":I
    .end local v24    # "value":Ljava/lang/String;
    .end local v28    # "x2":Ljava/lang/Throwable;
    :catch_5
    move-exception v16
    ...
    .restart local v28    # "x2":Ljava/lang/Throwable;
    move-object/from16 v0, v28

    invoke-virtual {v9, v0}, Ljava/lang/Throwable;->addSuppressed(Ljava/lang/Throwable;)V
    :try_end_d
    .catch Ljava/lang/StringIndexOutOfBoundsException; {:try_start_d .. :try_end_d} :catch_1
    ...
    const-string v29, "readNetworkHistory: No config file, revert to default, "
    ...
    invoke-virtual/range {v17 .. v17}, Ljava/io/DataInputStream;->close()V
    :try_end_e
    .catch Ljava/lang/StringIndexOutOfBoundsException; {:try_start_e .. :try_end_e} :catch_1
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7e0c4cee -> :sswitch_27
        -0x77e81a92 -> :sswitch_f
        -0x7719684c -> :sswitch_1d
        -0x740b4755 -> :sswitch_25
        -0x6f46bcc5 -> :sswitch_15
        -0x6f2cb82f -> :sswitch_8
        -0x689ee561 -> :sswitch_2b
        -0x622b2dfc -> :sswitch_7
        -0x525eb5b7 -> :sswitch_31
        -0x4aa3f8a2 -> :sswitch_2f
        -0x4a9f4f68 -> :sswitch_30
        -0x41c84b47 -> :sswitch_18
        -0x4177217a -> :sswitch_26
        -0x3e579e44 -> :sswitch_2c
        -0x38535683 -> :sswitch_b
        -0x310aba1b -> :sswitch_2d
        -0x2f732002 -> :sswitch_e
        -0x2e7dd20b -> :sswitch_2a
        ...
        0x392fc319 -> :sswitch_28
        0x3cbace17 -> :sswitch_3
        0x455dcbce -> :sswitch_2
        0x48325baa -> :sswitch_2e
...
.method private removeConfigAndSendBroadcastIfNeeded(I)Z
    ...
    .local v0, "config":Landroid/net/wifi/WifiConfiguration;
    :try_start_0
    iget-object v5, p0, Lcom/android/server/wifi/WifiConfigStore;->mtempConfiguredNetworks:Ljava/util/List;
    ...
    const-string v6, "=======CTRL-EVENT-BUFFER-FULL======enter removeDeadAp mtempConfiguredNetworks.remove"
    ...
    iget-object v6, p0, Lcom/android/server/wifi/WifiConfigStore;->lastSelectedConfiguration:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/wifi/WifiConfigStore;->removeKeys(Landroid/net/wifi/WifiEnterpriseConfig;)V
    ...
    iget-object v5, v0, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiConfigStore;->getChecksum(Ljava/lang/String;)Ljava/lang/Long;

    move-result-object v1

    .line 1616
    .local v1, "csum":Ljava/lang/Long;
    iget-object v5, p0, Lcom/android/server/wifi/WifiConfigStore;->mDeletedSSIDs:Ljava/util/Set;
    ...
    invoke-virtual {v5, p1}, Lcom/android/server/wifi/ConfigurationMap;->remove(I)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 1634
    invoke-virtual {p0, v7}, Lcom/android/server/wifi/WifiConfigStore;->writeKnownNetworkHistory(Z)V
...
.method addNetwork(Landroid/net/wifi/WifiConfiguration;)V
    .locals 5
    .param p1, "config"    # Landroid/net/wifi/WifiConfiguration;
    ...
    :goto_1
    invoke-direct {p0, p1, v4}, Lcom/android/server/wifi/WifiConfigStore;->addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
...
.method enableAllNetworks()V
    ...
    .end local v2    # "i$":Ljava/util/Iterator;
    :cond_4
    iget-object v6, p0, Lcom/android/server/wifi/WifiConfigStore;->enableAutoJoinWhenAssociated:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 1028
    :cond_6
    iget-object v6, v0, Landroid/net/wifi/WifiConfiguration;->visibility:Landroid/net/wifi/WifiConfiguration$Visibility;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/wifi/WifiConfigStore;->shouldEnabaleByRssi(I)Z
    ...
    const-string v7, "shouldEnabaleByRssi  in enableAllNetworks config.visibility.rssi24"
    ...
    const-string v7, "config.visibility.rssi5"
    ...
    .line 1050
    iput v10, v0, Landroid/net/wifi/WifiConfiguration;->disableReason:I
...
.method enableNetworkWithoutBroadcast(IZ)Z
    ...
    const-string v3, "enableNetworkWithoutBroadcast clear config.autoJoinStatus."

    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1731
    iput v4, v0, Landroid/net/wifi/WifiConfiguration;->numConnectionFailures:I

    .line 1732
    iput v4, v0, Landroid/net/wifi/WifiConfiguration;->numIpConfigFailures:I

    .line 1733
    iput v4, v0, Landroid/net/wifi/WifiConfiguration;->numAuthFailures:I
...
.method forgetNetwork(I)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/wifi/WifiConfigStore;->removeAPRelationShip(Landroid/net/wifi/WifiConfiguration;)V
...
.method public getReallyConfiguredNetworks()Lcom/android/server/wifi/ConfigurationMap;
    .locals 1
...
.method handleSSIDStateChange(IZLjava/lang/String;Ljava/lang/String;)V
    ...
    iget v4, p0, Lcom/android/server/wifi/WifiConfigStore;->wifiDynamicBlacklistMinTimeMilli:I
    ...
    const-string v5, "screenOff DHCP failure, blacklist "
    ...
    const-string v5, " screemOff Connection failure, blacklist "
...
.method public isAccessPointContact(I)Z
    .locals 5
    .param p1, "netId"    # I
    ...
    const-string v4, "isAccessPointContact netId:"
    ...
    const-string v4, "isAccessPointContact , configKey:"
    ...
    invoke-virtual {v0, v4}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;
    ...
    .line 5347
    iget-object v3, v0, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v3}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    invoke-virtual {v3}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContactSize()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "isAccessPointContact need:"
...
.method loadConfiguredNetworks()V
    ...
    iget-object v0, v0, Lcom/android/server/wifi/WifiConfigStore;->mtempConfiguredNetworks:Ljava/util/List;
    ...
    .line 2038
    const-string v20, "Error: get a config with SSID null"
    ...
    iput-boolean v0, v1, Lcom/android/server/wifi/WifiConfigStore;->shouldRemoveDeadAp:Z

    .line 2099
    const-string v20, "loadConfiguredNetworks loaded more than 100 shouldRemoveDeadAp=true"
...
.method public makeChannelList(Landroid/net/wifi/WifiConfiguration;IZ)Ljava/util/HashSet;
    ...
    const-string v20, "makeChannelList age="
    ...
    iget-object v0, v0, Lcom/android/server/wifi/WifiConfigStore;->maxNumActiveChannelsForPartialScans:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wifi/ScanDetailCache;->size()I
    ...
    .line 3704
    .local v11, "numChannels":I
    const/4 v4, 0x3

    .line 3711
    .local v4, "dynamicMaxNumActiveChannelsForPartialScans":I
    :try_start_0
    ...
    .line 3712
    .local v17, "savedContactMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Integer;>;"
    move-object/from16 v0, p1

    iget-object v0, v0, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    move-object/from16 v19, v0

    invoke-virtual/range {v19 .. v19}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    .line 3714
    .local v15, "savedContact":Landroid/net/wifi/WifiConfiguration;
    if-eqz v15, :cond_6

    .line 3716
    move-object/from16 v0, p0

    invoke-virtual {v0, v15}, Lcom/android/server/wifi/WifiConfigStore;->getScanDetailCache(Landroid/net/wifi/WifiConfiguration;)Lcom/android/server/wifi/ScanDetailCache;
    ...
    .line 3756
    .end local v6    # "freqsize":I
    .end local v8    # "i$":Ljava/util/Iterator;
    .end local v10    # "key":Ljava/lang/String;
    .end local v15    # "savedContact":Landroid/net/wifi/WifiConfiguration;
    .end local v17    # "savedContactMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Integer;>;"
    :catch_0
    move-exception v5
    ...
    const-string v21, "Error do savedContact ingore"
    ...
    .restart local v17    # "savedContactMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Integer;>;"
    :cond_8
    :try_start_1
    ...
    .line 3726
    .local v16, "savedContactInfos":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/Integer;>;>;"
    new-instance v19, Lcom/android/server/wifi/WifiConfigStore$4;

    move-object/from16 v0, v19

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/wifi/WifiConfigStore$4;-><init>(Lcom/android/server/wifi/WifiConfigStore;)V
    ...
    .line 3734
    .restart local v15    # "savedContact":Landroid/net/wifi/WifiConfiguration;
    if-nez v15, :cond_a
    ...
    check-cast v18, Lcom/android/server/wifi/ScanDetail;

    .line 3740
    .local v18, "scanDetail":Lcom/android/server/wifi/ScanDetail;
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/wifi/ScanDetail;->getScanResult()Landroid/net/wifi/ScanResult;
...
.method public removeAPRelationShip(Landroid/net/wifi/WifiConfiguration;)V
    .locals 6
    ...
    .line 5327
    .local v1, "configurationKey":Ljava/lang/String;
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "configurationKey:"
    ...
    invoke-virtual {v4}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    const-string v5, "removeAcessPointRelationship configurationKey:"
    ...
    invoke-virtual {v4, v1}, Landroid/net/wifi/VivoWifiConfiguration;->removeVivoAccessPointContact(Ljava/lang/String;)V
    ...
    .line 5335
    .end local v0    # "config":Landroid/net/wifi/WifiConfiguration;
    .end local v1    # "configurationKey":Ljava/lang/String;
    .end local v3    # "i$":Ljava/util/Iterator;
    :catch_0
    move-exception v2
...
.method removeNetwork(I)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wifi/WifiConfigStore;->removeAPRelationShip(Landroid/net/wifi/WifiConfiguration;)V
...
.method public setAPRalationShipWithLocation()V
    .locals 20
    ...
    invoke-virtual {v2}, Lcom/android/server/wifi/ConfigurationMap;->size()I
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/wifi/ConfigurationMap;->get(I)Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-virtual {v13, v2}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;

    move-result-object v14

    .line 5289
    .local v14, "currentConfigKey":Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "setAPRalationShipWithLocation currentConfigKey:"
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v2}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;
    ...
    const-string v3, "setAPRalationShipWithLocation configKey:"
    ...
    .line 5298
    iget-object v2, v13, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v2}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v3}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoAccessPointContact(Ljava/util/HashMap;)V

    .line 5301
    :cond_4
    iget-object v2, v13, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v2, v11}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v12

    .line 5302
    .local v12, "contact":Ljava/lang/Integer;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "setAPRalationShipWithLocation contact:"
    ...
    invoke-virtual {v2}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoLatitude()D

    move-result-wide v2

    iget-object v4, v13, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v4}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoLongitude()D

    move-result-wide v4

    iget-object v6, v10, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v6}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoLatitude()D

    move-result-wide v6

    iget-object v8, v10, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v8}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoLongitude()D

    move-result-wide v8

    invoke-static/range {v2 .. v9}, Lcom/android/server/wifi/VivoSmartWifiConstants;->getDistance(DDDD)D
    ...
    invoke-virtual {v2, v11, v3}, Landroid/net/wifi/VivoWifiConfiguration;->addVivoAccessPointContact(Ljava/lang/String;I)V
    ...
    const-string v3, "setAPRalationShipWithLocation put:"
    ...
    invoke-virtual {v10, v3}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;
    ...
    .end local v12    # "contact":Ljava/lang/Integer;
    .end local v13    # "currentConfig":Landroid/net/wifi/WifiConfiguration;
    .end local v14    # "currentConfigKey":Ljava/lang/String;
...
.method public setAPRalationShipWithScanResults()V
    .locals 12
    ...
    invoke-virtual {p0, v9, v10}, Lcom/android/server/wifi/WifiConfigStore;->getRecentConfiguredNetworks(IZ)Ljava/util/List;

    move-result-object v8

    .line 5249
    .local v8, "list":Ljava/util/List;, "Ljava/util/List<Landroid/net/wifi/WifiConfiguration;>;"
    if-eqz v8, :cond_4
    ...
    .line 5254
    .local v3, "currentConfig":Landroid/net/wifi/WifiConfiguration;
    const/4 v9, 0x1

    invoke-virtual {v3, v9}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;

    move-result-object v4

    .line 5255
    .local v4, "currentConfigKey":Ljava/lang/String;
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "setAPRalationShipWithScanResults currentConfigKey:"
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v9}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;
    ...
    const-string v10, "setAPRalationShipWithScanResults configKey:"
    ...
    .line 5261
    iget-object v9, v3, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v9}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact()Ljava/util/HashMap;
    ...
    invoke-virtual {v9, v10}, Landroid/net/wifi/VivoWifiConfiguration;->setVivoAccessPointContact(Ljava/util/HashMap;)V

    .line 5264
    :cond_0
    iget-object v9, v3, Landroid/net/wifi/WifiConfiguration;->vivoWifiConfiguration:Landroid/net/wifi/VivoWifiConfiguration;

    invoke-virtual {v9, v1}, Landroid/net/wifi/VivoWifiConfiguration;->getVivoAccessPointContact(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v2

    .line 5265
    .local v2, "contact":Ljava/lang/Integer;
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "setAPRalationShipWithScanResults contact:"
    ...
    invoke-virtual {v9, v1, v10}, Landroid/net/wifi/VivoWifiConfiguration;->addVivoAccessPointContact(Ljava/lang/String;I)V
    ...
    const-string v10, "setAPRalationShipWithScanResults put:"
    ...
    invoke-virtual {v0, v10}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;
    ...
    .line 5256
    .end local v2    # "contact":Ljava/lang/Integer;
    :cond_2
    add-int/lit8 v7, v7, 0x1
    ...
    .line 5274
    .end local v3    # "currentConfig":Landroid/net/wifi/WifiConfiguration;
    .end local v4    # "currentConfigKey":Ljava/lang/String;
    .end local v7    # "j":I
    :catch_0
    move-exception v5
...
.method public setAutoJoinEnabled()V
    .locals 5
    ...
    const-string v2, "vivo_wifi_auto_join"
    ...
    const-string v2, "WIFI_AUTO_JOIN enabled:"
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
...
.method setDynamicBlacklistTime(I)V
    .locals 0
    .param p1, "time"    # I

    .prologue
    .line 5172
    iput p1, p0, Lcom/android/server/wifi/WifiConfigStore;->wifiDynamicBlacklistMinTimeMilli:I
...
.method shouldEnabaleByRssi(I)Z
    .locals 7
    .param p1, "rssi"    # I
