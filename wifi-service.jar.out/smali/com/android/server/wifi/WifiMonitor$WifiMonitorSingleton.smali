...
.method private declared-synchronized dispatchEvent(Ljava/lang/String;)Z
    ...
    const-string v10, "persist.fst.rate.upgrade.en"
    ...
    const-string v11, "Ignoring fst rate upgrade event: "
    ...
    .restart local v8    # "space":I
    :cond_1
    :try_start_1
    iget-object v10, p0, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->mIfaceMap:Ljava/util/HashMap;
    ...
    .line 747
    .local v6, "m":Lcom/android/server/wifi/WifiMonitor;
    if-eqz v6, :cond_7
    ...
    iput-boolean v10, p0, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->mConnected:Z

    .line 755
    const-string v10, "net.wifi.hostapd"
    ...
    .line 756
    .local v3, "isHostapdRun":Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiMonitor;->access$600(Lcom/android/server/wifi/WifiMonitor;)Ljava/lang/String;
    ...
    invoke-static {v6, v10}, Lcom/android/server/wifi/WifiMonitor;->access$102(Lcom/android/server/wifi/WifiMonitor;Z)Z

    .line 759
    iget-object v10, p0, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->mWifiNative:Lcom/android/server/wifi/WifiNative;

    invoke-virtual {v10}, Lcom/android/server/wifi/WifiNative;->closeSupplicantConnection()V

    .line 760
    const-string v10, "WifiMonitor"

    const-string v11, "ap0 get TEMINATING 1"
    ...
    .line 736
    .end local v2    # "iface":Ljava/lang/String;
    .end local v3    # "isHostapdRun":Ljava/lang/String;
    .end local v6    # "m":Lcom/android/server/wifi/WifiMonitor;
    .restart local v8    # "space":I
    :cond_4
    const-string v9, "WifiMonitor"
    ...
    const-string v11, "Dropping malformed event (unparsable iface): "
    ...
    .line 771
    .restart local v6    # "m":Lcom/android/server/wifi/WifiMonitor;
    :cond_6
    ...
    const-string v10, "Sending to all monitors because there\'s no matching iface"
    ...
    check-cast v7, Lcom/android/server/wifi/WifiMonitor;

    .line 784
    .local v7, "monitor":Lcom/android/server/wifi/WifiMonitor;
    # getter for: Lcom/android/server/wifi/WifiMonitor;->mMonitoring:Z
    invoke-static {v7}, Lcom/android/server/wifi/WifiMonitor;->access$100(Lcom/android/server/wifi/WifiMonitor;)Z
    ...
    .line 786
    # invokes: Lcom/android/server/wifi/WifiMonitor;->dispatchEvent(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v7, p1, v2}, Lcom/android/server/wifi/WifiMonitor;->access$500(Lcom/android/server/wifi/WifiMonitor;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 792
    .end local v7    # "monitor":Lcom/android/server/wifi/WifiMonitor;
    :cond_b
    if-nez v4, :cond_c
    ...
    .line 801
    const-string v9, "net.wifi.hostapd"
    ...
    .line 802
    .restart local v3    # "isHostapdRun":Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/wifi/WifiMonitor;->mMonitoring:Z
    invoke-static {v6, v9}, Lcom/android/server/wifi/WifiMonitor;->access$102(Lcom/android/server/wifi/WifiMonitor;Z)Z
    ...
    const-string v10, "ap0 get TEMINATING 2"
...
.method public declared-synchronized stopMonitoring(Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/wifi/WifiMonitor;->mStateMachine:Lcom/android/internal/util/StateMachine;
    invoke-static {v1}, Lcom/android/server/wifi/WifiMonitor;->access$200(Lcom/android/server/wifi/WifiMonitor;)Lcom/android/internal/util/StateMachine;
    ...
    .line 664
    :cond_0
    const-string v2, "net.wifi.hostapd"
    ...
    .line 665
    .local v0, "isHostapdRun":Ljava/lang/String;
    ...
    .line 659
    .end local v0    # "isHostapdRun":Ljava/lang/String;
    .end local v1    # "m":Lcom/android/server/wifi/WifiMonitor;
    :catchall_0
    move-exception v2
