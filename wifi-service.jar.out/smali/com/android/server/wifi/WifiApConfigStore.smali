...
# static fields
.field private static AP_CONFIG_FILE:Ljava/lang/String; = null

.field private static final AP_CONFIG_FILE_APP:Ljava/lang/String;

.field private static final AP_CONFIG_FILE_SYSTEM:Ljava/lang/String;

.field private static final AP_CONFIG_FILE_VERSION:I = 0x2

.field private static RequestcallingUid:I = 0x0

.field private static SetApcallingUid:I = 0x0
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wifi/WifiApConfigStore;->AP_CONFIG_FILE_SYSTEM:Ljava/lang/String;
    ...
    const-string v1, "/misc/wifi/softap_app.conf"
    ...
    sput-object v0, Lcom/android/server/wifi/WifiApConfigStore;->AP_CONFIG_FILE_APP:Ljava/lang/String;

    .line 64
    sput v2, Lcom/android/server/wifi/WifiApConfigStore;->SetApcallingUid:I

    .line 65
    sput v2, Lcom/android/server/wifi/WifiApConfigStore;->RequestcallingUid:I
...
.method static synthetic access$002(I)I
    ...
    .prologue
    .line 53
    sput p0, Lcom/android/server/wifi/WifiApConfigStore;->RequestcallingUid:I
...
.method static synthetic access$302(I)I
    ...
    .prologue
    .line 53
    sput p0, Lcom/android/server/wifi/WifiApConfigStore;->SetApcallingUid:I
...
.method private isThirdApConfigOpen(Landroid/net/wifi/WifiConfiguration;)V
    .locals 4
    ...
    .line 308
    .local v0, "keyMgmt":Ljava/util/BitSet;
    ...
    .line 310
    :cond_0
    const-string v1, "net.wifi.vivosoftap.KeyMgmt"
    ...
    const-string v2, "isThirdApConfigOpen : true"
    ...
    .line 323
    .end local v0    # "keyMgmt":Ljava/util/BitSet;
    :cond_1
    return-void

    .line 313
    .restart local v0    # "keyMgmt":Ljava/util/BitSet;
    :cond_2
    const-string v1, "net.wifi.vivosoftap.KeyMgmt"
    ...
    const-string v2, "isThirdApConfigOpen : false"
...
.method private setDefaultApConfiguration()V
    ...
    sget v4, Lcom/android/server/wifi/WifiApConfigStore;->SetApcallingUid:I

    invoke-virtual {p0, v3, v6, v4, v1}, Lcom/android/server/wifi/WifiApConfigStore;->sendMessage(IIILjava/lang/Object;)V
...
.method private writeApConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/wifi/WifiApConfigStore;->checkApConfigFile(I)V

    .line 235
    invoke-direct {p0, p1}, Lcom/android/server/wifi/WifiApConfigStore;->isThirdApConfigOpen(Landroid/net/wifi/WifiConfiguration;)V
    ...
    const-string v6, "writeApConfiguration "
...
.method checkApConfigFile(I)V
    ...
    const-string v2, " checkApConfigFile :callingUid is "
    ...
    .line 299
    sget-object v0, Lcom/android/server/wifi/WifiApConfigStore;->AP_CONFIG_FILE_APP:Ljava/lang/String;
    ...
    .line 301
    :cond_0
    sget-object v0, Lcom/android/server/wifi/WifiApConfigStore;->AP_CONFIG_FILE_SYSTEM:Ljava/lang/String;
...
.method loadApConfiguration()V
    ...
    const-string v8, "loadApConfiguration"

    invoke-static {v7, v8}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 182
    sget v7, Lcom/android/server/wifi/WifiApConfigStore;->RequestcallingUid:I

    invoke-virtual {p0, v7}, Lcom/android/server/wifi/WifiApConfigStore;->checkApConfigFile(I)V
    ...
    .line 192
    sget v6, Lcom/android/server/wifi/WifiApConfigStore;->RequestcallingUid:I

    sput v6, Lcom/android/server/wifi/WifiApConfigStore;->SetApcallingUid:I
