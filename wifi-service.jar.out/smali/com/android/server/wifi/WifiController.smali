...
.field private static final CMCC_PROP_VALUE:Ljava/lang/String; = "CMCC_RW"
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, v6, p3}, Lcom/android/internal/util/StateMachine;-><init>(Ljava/lang/String;Landroid/os/Looper;)V

    .line 63
    iput-boolean v10, p0, Lcom/android/server/wifi/WifiController;->mFirstUserSignOnSeen:Z
    ...
    .line 146
    iget-object v6, p2, Lcom/android/server/wifi/WifiServiceImpl;->mWifiStateMachine:Lcom/android/server/wifi/WifiStateMachine;

    iput-object v6, p0, Lcom/android/server/wifi/WifiController;->mWifiStateMachine:Lcom/android/server/wifi/WifiStateMachine;

    .line 147
    iget-object v6, p2, Lcom/android/server/wifi/WifiServiceImpl;->mSettingsStore:Lcom/android/server/wifi/WifiSettingsStore;

    iput-object v6, p0, Lcom/android/server/wifi/WifiController;->mSettingsStore:Lcom/android/server/wifi/WifiSettingsStore;

    .line 148
    iget-object v6, p2, Lcom/android/server/wifi/WifiServiceImpl;->mLocks:Lcom/android/server/wifi/WifiServiceImpl$LockList;

    iput-object v6, p0, Lcom/android/server/wifi/WifiController;->mLocks:Lcom/android/server/wifi/WifiServiceImpl$LockList;
    ...
    const-string v7, ", isScanningAvailable = "
    ...
    .line 177
    const-string v6, "persist.sys.factory.mode"
    ...
    .line 178
    .local v3, "isInFactoryMode":Ljava/lang/String;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "isInFactoryMode = "
    ...
    .line 187
    invoke-virtual {p0, v10}, Lcom/android/server/wifi/WifiController;->setLogOnlyTransitions(Z)V
    ...
    invoke-direct {v8, v0}, Landroid/content/IntentFilter;-><init>(Landroid/content/IntentFilter;)V
